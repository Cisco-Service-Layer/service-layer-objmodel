...
class SLBfdv4Key PROTOBUF_FINAL :
 ...
 public:
  ...
  inline SLBfdv4Key* New() const final {
    return CreateMaybeMessage<SLBfdv4Key>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_sl_5fbfd_5fipv4_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class SLBfdv4SessionCfg PROTOBUF_FINAL :
 ...
 public:
  ...
  inline SLBfdv4SessionCfg* New() const final {
    return CreateMaybeMessage<SLBfdv4SessionCfg>(nullptr);
  }
...
class SLBfdv4Msg PROTOBUF_FINAL :
 ...
 public:
  ...
  inline SLBfdv4Msg* New() const final {
    return CreateMaybeMessage<SLBfdv4Msg>(nullptr);
  }
...
class SLBfdv4Res PROTOBUF_FINAL :
 ...
 public:
  ...
  inline SLBfdv4Res* New() const final {
    return CreateMaybeMessage<SLBfdv4Res>(nullptr);
  }
...
class SLBfdv4MsgRsp PROTOBUF_FINAL :
 ...
 public:
  ...
  inline SLBfdv4MsgRsp* New() const final {
    return CreateMaybeMessage<SLBfdv4MsgRsp>(nullptr);
  }
...
class SLBfdv4GetMsg PROTOBUF_FINAL :
 ...
 public:
  ...
  inline SLBfdv4GetMsg* New() const final {
    return CreateMaybeMessage<SLBfdv4GetMsg>(nullptr);
  }
...
class SLBfdv4SessionCfgState PROTOBUF_FINAL :
 ...
 public:
  ...
  inline SLBfdv4SessionCfgState* New() const final {
    return CreateMaybeMessage<SLBfdv4SessionCfgState>(nullptr);
  }
...
class SLBfdv4GetMsgRsp PROTOBUF_FINAL :
 ...
 public:
  ...
  inline SLBfdv4GetMsgRsp* New() const final {
    return CreateMaybeMessage<SLBfdv4GetMsgRsp>(nullptr);
  }
...
class SLBfdv4SessionState PROTOBUF_FINAL :
 ...
 public:
  ...
  inline SLBfdv4SessionState* New() const final {
    return CreateMaybeMessage<SLBfdv4SessionState>(nullptr);
  }
...
class SLBfdv4Notif PROTOBUF_FINAL :
 ...
 public:
  ...
  inline SLBfdv4Notif* New() const final {
    return CreateMaybeMessage<SLBfdv4Notif>(nullptr);
  }
...
inline std::string* SLBfdv4Key::unsafe_arena_release_vrfname() {
  // @@protoc_insertion_point(field_unsafe_arena_release:service_layer.SLBfdv4Key.VrfName)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return vrfname_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SLBfdv4Key::unsafe_arena_set_allocated_vrfname(
    std::string* vrfname) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (vrfname != nullptr) {
  ...
  vrfname_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      vrfname, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:service_layer.SLBfdv4Key.VrfName)
}
...
inline ::service_layer::SLBfdv4Key* SLBfdv4SessionCfg::_internal_mutable_key() {
  ...
  if (key_ == nullptr) {
    auto* p = CreateMaybeMessage<::service_layer::SLBfdv4Key>(GetArena());
    key_ = p;
  }
  return key_;
}
...
inline ::service_layer::SLBfdv4SessionState* SLBfdv4Notif::_internal_mutable_session() {
  if (!_internal_has_session()) {
    clear_Event();
    set_has_session();
    Event_.session_ = CreateMaybeMessage< ::service_layer::SLBfdv4SessionState >(GetArena());
  }
