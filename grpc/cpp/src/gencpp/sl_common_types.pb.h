...
enum SLErrorStatus_SLErrno : int {
  ...
  SLErrorStatus_SLErrno_SL_PATH_SRC_DES_AFI_MISMATCH = 20506,
  SLErrorStatus_SLErrno_SL_PATH_RTR_MAC_VXLAN_NOSUP = 20507,
  SLErrorStatus_SLErrno_SL_PATH_ENCAP_TYPE_VXLANPATH_MISMATCH = 20508,
...
class SLErrorStatus final :
 ...
 public:
  ...
  static constexpr SLErrno SL_PATH_SRC_DES_AFI_MISMATCH =
    SLErrorStatus_SLErrno_SL_PATH_SRC_DES_AFI_MISMATCH;
  static constexpr SLErrno SL_PATH_RTR_MAC_VXLAN_NOSUP =
    SLErrorStatus_SLErrno_SL_PATH_RTR_MAC_VXLAN_NOSUP;
  static constexpr SLErrno SL_PATH_ENCAP_TYPE_VXLANPATH_MISMATCH =
    SLErrorStatus_SLErrno_SL_PATH_ENCAP_TYPE_VXLANPATH_MISMATCH;
