...
void protobuf_AddDesc_sl_5fcommon_5ftypes_2eproto();
void protobuf_AssignDesc_sl_5fcommon_5ftypes_2eproto();
void protobuf_ShutdownFile_sl_5fcommon_5ftypes_2eproto();
...
class SLErrorStatus : public ::google::protobuf::Message {
 public:
  SLErrorStatus();
  ...
  inline SLErrorStatus* New() const { return New(NULL); }

  SLErrorStatus* New(::google::protobuf::Arena* arena) const;
  ...
  static const SLErrno SL_SUCCESS = SLErrorStatus_SLErrno_SL_SUCCESS;
  static const SLErrno SL_NOT_CONNECTED = SLErrorStatus_SLErrno_SL_NOT_CONNECTED;
  static const SLErrno SL_EAGAIN = SLErrorStatus_SLErrno_SL_EAGAIN;
  static const SLErrno SL_ENOMEM = SLErrorStatus_SLErrno_SL_ENOMEM;
  static const SLErrno SL_EBUSY = SLErrorStatus_SLErrno_SL_EBUSY;
  static const SLErrno SL_EINVAL = SLErrorStatus_SLErrno_SL_EINVAL;
  static const SLErrno SL_UNSUPPORTED_VER = SLErrorStatus_SLErrno_SL_UNSUPPORTED_VER;
  static const SLErrno SL_NOT_AVAILABLE = SLErrorStatus_SLErrno_SL_NOT_AVAILABLE;
  static const SLErrno SL_STREAM_NOT_SUPPORTED = SLErrorStatus_SLErrno_SL_STREAM_NOT_SUPPORTED;
  static const SLErrno SL_ENOTSUP = SLErrorStatus_SLErrno_SL_ENOTSUP;
  static const SLErrno SL_SOME_ERR = SLErrorStatus_SLErrno_SL_SOME_ERR;
  static const SLErrno SL_TIMEOUT = SLErrorStatus_SLErrno_SL_TIMEOUT;
  static const SLErrno SL_NOTIF_TERM = SLErrorStatus_SLErrno_SL_NOTIF_TERM;
  static const SLErrno SL_INIT_START_OFFSET = SLErrorStatus_SLErrno_SL_INIT_START_OFFSET;
  static const SLErrno SL_INIT_STATE_CLEAR = SLErrorStatus_SLErrno_SL_INIT_STATE_CLEAR;
  static const SLErrno SL_INIT_STATE_READY = SLErrorStatus_SLErrno_SL_INIT_STATE_READY;
  static const SLErrno SL_INIT_UNSUPPORTED_VER = SLErrorStatus_SLErrno_SL_INIT_UNSUPPORTED_VER;
  static const SLErrno SL_INIT_SERVER_NOT_INITIALIZED = SLErrorStatus_SLErrno_SL_INIT_SERVER_NOT_INITIALIZED;
  static const SLErrno SL_INIT_SERVER_MODE_CHANGE_FAILED = SLErrorStatus_SLErrno_SL_INIT_SERVER_MODE_CHANGE_FAILED;
  static const SLErrno SL_RPC_VRF_START_OFFSET = SLErrorStatus_SLErrno_SL_RPC_VRF_START_OFFSET;
  static const SLErrno SL_RPC_VRF_TOO_MANY_VRF_REG_MSGS = SLErrorStatus_SLErrno_SL_RPC_VRF_TOO_MANY_VRF_REG_MSGS;
  static const SLErrno SL_RPC_VRF_SERVER_NOT_INITIALIZED = SLErrorStatus_SLErrno_SL_RPC_VRF_SERVER_NOT_INITIALIZED;
  static const SLErrno SL_VRF_START_OFFSET = SLErrorStatus_SLErrno_SL_VRF_START_OFFSET;
  static const SLErrno SL_VRF_NAME_TOOLONG = SLErrorStatus_SLErrno_SL_VRF_NAME_TOOLONG;
  static const SLErrno SL_VRF_NOT_FOUND = SLErrorStatus_SLErrno_SL_VRF_NOT_FOUND;
  static const SLErrno SL_VRF_NO_TABLE_ID = SLErrorStatus_SLErrno_SL_VRF_NO_TABLE_ID;
  static const SLErrno SL_VRF_REG_INVALID_ADMIN_DISTANCE = SLErrorStatus_SLErrno_SL_VRF_REG_INVALID_ADMIN_DISTANCE;
  static const SLErrno SL_VRF_TABLE_ADD_ERR = SLErrorStatus_SLErrno_SL_VRF_TABLE_ADD_ERR;
  static const SLErrno SL_VRF_TABLE_REGISTRATION_ERR = SLErrorStatus_SLErrno_SL_VRF_TABLE_REGISTRATION_ERR;
  static const SLErrno SL_VRF_TABLE_UNREGISTRATION_ERR = SLErrorStatus_SLErrno_SL_VRF_TABLE_UNREGISTRATION_ERR;
  static const SLErrno SL_VRF_TABLE_EOF_ERR = SLErrorStatus_SLErrno_SL_VRF_TABLE_EOF_ERR;
  static const SLErrno SL_VRF_REG_VRF_NAME_MISSING = SLErrorStatus_SLErrno_SL_VRF_REG_VRF_NAME_MISSING;
  static const SLErrno SL_RPC_ROUTE_START_OFFSET = SLErrorStatus_SLErrno_SL_RPC_ROUTE_START_OFFSET;
  static const SLErrno SL_RPC_ROUTE_TOO_MANY_ROUTES = SLErrorStatus_SLErrno_SL_RPC_ROUTE_TOO_MANY_ROUTES;
  static const SLErrno SL_RPC_ROUTE_VRF_NAME_TOOLONG = SLErrorStatus_SLErrno_SL_RPC_ROUTE_VRF_NAME_TOOLONG;
  static const SLErrno SL_RPC_ROUTE_VRF_NOT_FOUND = SLErrorStatus_SLErrno_SL_RPC_ROUTE_VRF_NOT_FOUND;
  static const SLErrno SL_RPC_ROUTE_VRF_NO_TABLE = SLErrorStatus_SLErrno_SL_RPC_ROUTE_VRF_NO_TABLE;
  static const SLErrno SL_RPC_ROUTE_VRF_TABLE_NOT_REGISTERED = SLErrorStatus_SLErrno_SL_RPC_ROUTE_VRF_TABLE_NOT_REGISTERED;
  static const SLErrno SL_RPC_ROUTE_VRF_NAME_MISSING = SLErrorStatus_SLErrno_SL_RPC_ROUTE_VRF_NAME_MISSING;
  static const SLErrno SL_RPC_ROUTE_INIT_MODE_INCOMPATIBLE = SLErrorStatus_SLErrno_SL_RPC_ROUTE_INIT_MODE_INCOMPATIBLE;
  static const SLErrno SL_RPC_ROUTE_SERVER_NOT_INITIALIZED = SLErrorStatus_SLErrno_SL_RPC_ROUTE_SERVER_NOT_INITIALIZED;
  static const SLErrno SL_ROUTE_START_OFFSET = SLErrorStatus_SLErrno_SL_ROUTE_START_OFFSET;
  static const SLErrno SL_ROUTE_ADD_NO_PATHS = SLErrorStatus_SLErrno_SL_ROUTE_ADD_NO_PATHS;
  static const SLErrno SL_ROUTE_UPDATE_NO_PATHS = SLErrorStatus_SLErrno_SL_ROUTE_UPDATE_NO_PATHS;
  static const SLErrno SL_ROUTE_INVALID_PREFIX_LEN = SLErrorStatus_SLErrno_SL_ROUTE_INVALID_PREFIX_LEN;
  static const SLErrno SL_ROUTE_INVALID_ADMIN_DISTANCE = SLErrorStatus_SLErrno_SL_ROUTE_INVALID_ADMIN_DISTANCE;
  static const SLErrno SL_ROUTE_INVALID_NUM_PATHS = SLErrorStatus_SLErrno_SL_ROUTE_INVALID_NUM_PATHS;
  static const SLErrno SL_ROUTE_INVALID_PREFIX_SZ = SLErrorStatus_SLErrno_SL_ROUTE_INVALID_PREFIX_SZ;
  static const SLErrno SL_ROUTE_INVALID_PREFIX = SLErrorStatus_SLErrno_SL_ROUTE_INVALID_PREFIX;
  static const SLErrno SL_ROUTE_ERR_RIB_TABLE_LIMIT_REACHED = SLErrorStatus_SLErrno_SL_ROUTE_ERR_RIB_TABLE_LIMIT_REACHED;
  static const SLErrno SL_ROUTE_ERR_RIB_INVALID_ARGS = SLErrorStatus_SLErrno_SL_ROUTE_ERR_RIB_INVALID_ARGS;
  static const SLErrno SL_ROUTE_ERR_RIB_PATH_TABLE_LIMIT = SLErrorStatus_SLErrno_SL_ROUTE_ERR_RIB_PATH_TABLE_LIMIT;
  static const SLErrno SL_ROUTE_ERR_RIB_TOOMANYPATHS = SLErrorStatus_SLErrno_SL_ROUTE_ERR_RIB_TOOMANYPATHS;
  static const SLErrno SL_ROUTE_EEXIST = SLErrorStatus_SLErrno_SL_ROUTE_EEXIST;
  static const SLErrno SL_ROUTE_HOST_BITS_SET = SLErrorStatus_SLErrno_SL_ROUTE_HOST_BITS_SET;
  static const SLErrno SL_ROUTE_INVALID_PREFIX_MCAST = SLErrorStatus_SLErrno_SL_ROUTE_INVALID_PREFIX_MCAST;
  static const SLErrno SL_ROUTE_PATH_AFI_MISMATCH = SLErrorStatus_SLErrno_SL_ROUTE_PATH_AFI_MISMATCH;
  static const SLErrno SL_ROUTE_TOOMANY_PRIMARY_PATHS = SLErrorStatus_SLErrno_SL_ROUTE_TOOMANY_PRIMARY_PATHS;
  static const SLErrno SL_ROUTE_TOOMANY_BACKUP_PATHS = SLErrorStatus_SLErrno_SL_ROUTE_TOOMANY_BACKUP_PATHS;
  static const SLErrno SL_ROUTE_DB_NOMEM = SLErrorStatus_SLErrno_SL_ROUTE_DB_NOMEM;
  static const SLErrno SL_ROUTE_INVALID_LOCAL_LABEL = SLErrorStatus_SLErrno_SL_ROUTE_INVALID_LOCAL_LABEL;
  static const SLErrno SL_PATH_START_OFFSET = SLErrorStatus_SLErrno_SL_PATH_START_OFFSET;
  static const SLErrno SL_PATH_NH_NO_TABLE = SLErrorStatus_SLErrno_SL_PATH_NH_NO_TABLE;
  static const SLErrno SL_PATH_NH_INTF_NOT_FOUND = SLErrorStatus_SLErrno_SL_PATH_NH_INTF_NOT_FOUND;
  static const SLErrno SL_PATH_INVALID_LABEL_COUNT = SLErrorStatus_SLErrno_SL_PATH_INVALID_LABEL_COUNT;
  static const SLErrno SL_PATH_INVALID_ID = SLErrorStatus_SLErrno_SL_PATH_INVALID_ID;
  static const SLErrno SL_PATH_VRF_NAME_TOOLONG = SLErrorStatus_SLErrno_SL_PATH_VRF_NAME_TOOLONG;
  static const SLErrno SL_PATH_NH_INTF_NAME_TOOLONG = SLErrorStatus_SLErrno_SL_PATH_NH_INTF_NAME_TOOLONG;
  static const SLErrno SL_PATH_NH_INVALID_ADDR_SZ = SLErrorStatus_SLErrno_SL_PATH_NH_INVALID_ADDR_SZ;
  static const SLErrno SL_PATH_NH_INF_NAME_MISSING = SLErrorStatus_SLErrno_SL_PATH_NH_INF_NAME_MISSING;
  static const SLErrno SL_PATH_INVALID_NEXT_HOP_ADDR = SLErrorStatus_SLErrno_SL_PATH_INVALID_NEXT_HOP_ADDR;
  static const SLErrno SL_PATH_INVALID_REMOTE_ADDR_COUNT = SLErrorStatus_SLErrno_SL_PATH_INVALID_REMOTE_ADDR_COUNT;
  static const SLErrno SL_PATH_REMOTE_ADDR_INVALID_SZ = SLErrorStatus_SLErrno_SL_PATH_REMOTE_ADDR_INVALID_SZ;
  static const SLErrno SL_PATH_REMOTE_ADDR_AFI_MISMATCH = SLErrorStatus_SLErrno_SL_PATH_REMOTE_ADDR_AFI_MISMATCH;
  static const SLErrno SL_PATH_INVALID_PROTECTED_BITMAP = SLErrorStatus_SLErrno_SL_PATH_INVALID_PROTECTED_BITMAP;
  static const SLErrno SL_PATH_BACKUP_MISSING_PRIMARY_PATH = SLErrorStatus_SLErrno_SL_PATH_BACKUP_MISSING_PRIMARY_PATH;
  static const SLErrno SL_PATH_PRIMARY_ID_REPEATED = SLErrorStatus_SLErrno_SL_PATH_PRIMARY_ID_REPEATED;
  static const SLErrno SL_PATH_BACKUP_ID_REPEATED = SLErrorStatus_SLErrno_SL_PATH_BACKUP_ID_REPEATED;
  static const SLErrno SL_PATH_PRIMARY_TOOMANY_BACKUP_PATHS = SLErrorStatus_SLErrno_SL_PATH_PRIMARY_TOOMANY_BACKUP_PATHS;
  static const SLErrno SL_PATH_PRIMARY_TOOMANY_LABELS = SLErrorStatus_SLErrno_SL_PATH_PRIMARY_TOOMANY_LABELS;
  static const SLErrno SL_PATH_PRIMARY_TOOMANY_REMOTE_ADDR = SLErrorStatus_SLErrno_SL_PATH_PRIMARY_TOOMANY_REMOTE_ADDR;
  static const SLErrno SL_PATH_REMOTE_ADDR_INVALID = SLErrorStatus_SLErrno_SL_PATH_REMOTE_ADDR_INVALID;
  static const SLErrno SL_PATH_INVALID_LABEL = SLErrorStatus_SLErrno_SL_PATH_INVALID_LABEL;
  static const SLErrno SL_RPC_BFD_START_OFFSET = SLErrorStatus_SLErrno_SL_RPC_BFD_START_OFFSET;
  static const SLErrno SL_RPC_BFD_TOO_MANY_BFD_SESSIONS = SLErrorStatus_SLErrno_SL_RPC_BFD_TOO_MANY_BFD_SESSIONS;
  static const SLErrno SL_RPC_BFD_API_BAD_PARAMETER = SLErrorStatus_SLErrno_SL_RPC_BFD_API_BAD_PARAMETER;
  static const SLErrno SL_RPC_BFD_API_CLIENT_NOT_REGISTERED = SLErrorStatus_SLErrno_SL_RPC_BFD_API_CLIENT_NOT_REGISTERED;
  static const SLErrno SL_RPC_BFD_API_INTERNAL_ERROR = SLErrorStatus_SLErrno_SL_RPC_BFD_API_INTERNAL_ERROR;
  static const SLErrno SL_RPC_BFD_SERVER_NOT_INITIALIZED = SLErrorStatus_SLErrno_SL_RPC_BFD_SERVER_NOT_INITIALIZED;
  static const SLErrno SL_RPC_BFD_V4_NOT_REGISTERED = SLErrorStatus_SLErrno_SL_RPC_BFD_V4_NOT_REGISTERED;
  static const SLErrno SL_RPC_BFD_V6_NOT_REGISTERED = SLErrorStatus_SLErrno_SL_RPC_BFD_V6_NOT_REGISTERED;
  ...
  static const SLErrno SL_BFD_VRF_NAME_TOOLONG = SLErrorStatus_SLErrno_SL_BFD_VRF_NAME_TOOLONG;
  static const SLErrno SL_BFD_BAD_PARAMETER = SLErrorStatus_SLErrno_SL_BFD_BAD_PARAMETER;
  static const SLErrno SL_BFD_API_INTERNAL_ERROR = SLErrorStatus_SLErrno_SL_BFD_API_INTERNAL_ERROR;
  static const SLErrno SL_BFD_VRF_NOT_FOUND = SLErrorStatus_SLErrno_SL_BFD_VRF_NOT_FOUND;
  static const SLErrno SL_BFD_INVALID_PREFIX_SIZE = SLErrorStatus_SLErrno_SL_BFD_INVALID_PREFIX_SIZE;
  static const SLErrno SL_BFD_INVALID_SESSION_TYPE = SLErrorStatus_SLErrno_SL_BFD_INVALID_SESSION_TYPE;
  static const SLErrno SL_BFD_INVALID_VRF = SLErrorStatus_SLErrno_SL_BFD_INVALID_VRF;
  static const SLErrno SL_BFD_SESSION_NOT_FOUND = SLErrorStatus_SLErrno_SL_BFD_SESSION_NOT_FOUND;
  static const SLErrno SL_BFD_SESSION_EXISTS = SLErrorStatus_SLErrno_SL_BFD_SESSION_EXISTS;
  static const SLErrno SL_BFD_INTERNAL_DB_ERROR = SLErrorStatus_SLErrno_SL_BFD_INTERNAL_DB_ERROR;
  static const SLErrno SL_BFD_RECOVERY_ERROR = SLErrorStatus_SLErrno_SL_BFD_RECOVERY_ERROR;
  static const SLErrno SL_RPC_MPLS_START_OFFSET = SLErrorStatus_SLErrno_SL_RPC_MPLS_START_OFFSET;
  static const SLErrno SL_RPC_MPLS_ILM_TOO_MANY_ILMS = SLErrorStatus_SLErrno_SL_RPC_MPLS_ILM_TOO_MANY_ILMS;
  ...
  static const SLErrno SL_ILM_INVALID_NUM_NHLFE = SLErrorStatus_SLErrno_SL_ILM_INVALID_NUM_NHLFE;
  static const SLErrno SL_ILM_INVALID_LABEL = SLErrorStatus_SLErrno_SL_ILM_INVALID_LABEL;
  static const SLErrno SL_ILM_DELETE_FAILED = SLErrorStatus_SLErrno_SL_ILM_DELETE_FAILED;
  static const SLErrno SL_ILM_LSD_DELETE_FAILED = SLErrorStatus_SLErrno_SL_ILM_LSD_DELETE_FAILED;
  static const SLErrno SL_ILM_TOOMANY_PRIMARY_NHLFES = SLErrorStatus_SLErrno_SL_ILM_TOOMANY_PRIMARY_NHLFES;
  ...
  static const SLErrno SL_NHLFE_INVALID_NEXT_HOP_ADDR = SLErrorStatus_SLErrno_SL_NHLFE_INVALID_NEXT_HOP_ADDR;
  static const SLErrno SL_NHLFE_VRF_NAME_TOOLONG = SLErrorStatus_SLErrno_SL_NHLFE_VRF_NAME_TOOLONG;
  static const SLErrno SL_NHLFE_NH_INF_NAME_MISSING = SLErrorStatus_SLErrno_SL_NHLFE_NH_INF_NAME_MISSING;
  static const SLErrno SL_NHLFE_NH_INTF_NAME_TOOLONG = SLErrorStatus_SLErrno_SL_NHLFE_NH_INTF_NAME_TOOLONG;
  static const SLErrno SL_NHLFE_INVALID_LABEL_COUNT = SLErrorStatus_SLErrno_SL_NHLFE_INVALID_LABEL_COUNT;
  static const SLErrno SL_NHLFE_INVALID_PATH_ID = SLErrorStatus_SLErrno_SL_NHLFE_INVALID_PATH_ID;
  static const SLErrno SL_NHLFE_INVALID_LABEL = SLErrorStatus_SLErrno_SL_NHLFE_INVALID_LABEL;
  static const SLErrno SL_NHLFE_INVALID_PROTECTED_BITMAP = SLErrorStatus_SLErrno_SL_NHLFE_INVALID_PROTECTED_BITMAP;
  static const SLErrno SL_NHLFE_INVALID_REMOTE_ADDR_COUNT = SLErrorStatus_SLErrno_SL_NHLFE_INVALID_REMOTE_ADDR_COUNT;
  static const SLErrno SL_NHLFE_REMOTE_ADDR_INVALID_SZ = SLErrorStatus_SLErrno_SL_NHLFE_REMOTE_ADDR_INVALID_SZ;
  static const SLErrno SL_NHLFE_PRIMARY_TOOMANY_LABELS = SLErrorStatus_SLErrno_SL_NHLFE_PRIMARY_TOOMANY_LABELS;
  static const SLErrno SL_NHLFE_PRIMARY_TOOMANY_REMOTE_ADDR = SLErrorStatus_SLErrno_SL_NHLFE_PRIMARY_TOOMANY_REMOTE_ADDR;
  static const SLErrno SL_NHLFE_BACKUP_ID_REPEATED = SLErrorStatus_SLErrno_SL_NHLFE_BACKUP_ID_REPEATED;
  static const SLErrno SL_NHLFE_PRIMARY_ID_REPEATED = SLErrorStatus_SLErrno_SL_NHLFE_PRIMARY_ID_REPEATED;
  static const SLErrno SL_NHLFE_BACKUP_PROTECTED_BITMAP_EMPTY = SLErrorStatus_SLErrno_SL_NHLFE_BACKUP_PROTECTED_BITMAP_EMPTY;
  static const SLErrno SL_NHLFE_PRIMARY_TOOMANY_BACKUP_PATHS = SLErrorStatus_SLErrno_SL_NHLFE_PRIMARY_TOOMANY_BACKUP_PATHS;
  static const SLErrno SL_NHLFE_REMOTE_ADDR_INVALID = SLErrorStatus_SLErrno_SL_NHLFE_REMOTE_ADDR_INVALID;
  static const SLErrno SL_NHLFE_BACKUP_MISSING_PRIMARY_PATH = SLErrorStatus_SLErrno_SL_NHLFE_BACKUP_MISSING_PRIMARY_PATH;
  static const SLErrno SL_NHLFE_NEXT_HOP_MISSING = SLErrorStatus_SLErrno_SL_NHLFE_NEXT_HOP_MISSING;
  static const SLErrno SL_NHLFE_LABEL_ACTION_INVALID = SLErrorStatus_SLErrno_SL_NHLFE_LABEL_ACTION_INVALID;
  static const SLErrno SL_NHLFE_NH_INTF_NOT_FOUND = SLErrorStatus_SLErrno_SL_NHLFE_NH_INTF_NOT_FOUND;
  static const SLErrno SL_NHLFE_OPER_FAILED = SLErrorStatus_SLErrno_SL_NHLFE_OPER_FAILED;
  static const SLErrno SL_NHLFE_LABEL_ACTION_MISSING = SLErrorStatus_SLErrno_SL_NHLFE_LABEL_ACTION_MISSING;
  static const SLErrno SL_LABEL_BLK_ERR_OFFSET = SLErrorStatus_SLErrno_SL_LABEL_BLK_ERR_OFFSET;
  static const SLErrno SL_LABEL_BLK_LSD_ADD_FAILED = SLErrorStatus_SLErrno_SL_LABEL_BLK_LSD_ADD_FAILED;
  static const SLErrno SL_LABEL_BLK_LSD_DELETE_FAILED = SLErrorStatus_SLErrno_SL_LABEL_BLK_LSD_DELETE_FAILED;
  static const SLErrno SL_LABEL_BLK_LSD_LABEL_BLK_NOT_FOUND = SLErrorStatus_SLErrno_SL_LABEL_BLK_LSD_LABEL_BLK_NOT_FOUND;
  static const SLErrno SL_LABEL_BLK_LSD_LABEL_BLK_IN_USE = SLErrorStatus_SLErrno_SL_LABEL_BLK_LSD_LABEL_BLK_IN_USE;
  ...
  static const SLErrno SL_MPLS_EOF_ERR = SLErrorStatus_SLErrno_SL_MPLS_EOF_ERR;
  ...
  // optional .service_layer.SLErrorStatus.SLErrno Status = 1;
  void clear_status();
 ...
 private:
  ...
  friend void  protobuf_AddDesc_sl_5fcommon_5ftypes_2eproto();
  friend void protobuf_AssignDesc_sl_5fcommon_5ftypes_2eproto();
  friend void protobuf_ShutdownFile_sl_5fcommon_5ftypes_2eproto();

  void InitAsDefaultInstance();
  static SLErrorStatus* default_instance_;
};
// -------------------------------------------------------------------

class SLInterface : public ::google::protobuf::Message {
 public:
  SLInterface();
  virtual ~SLInterface();
  ...
  inline SLInterface* New() const { return New(NULL); }

  SLInterface* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static SLInterface* default_instance_;
};
// -------------------------------------------------------------------

class SLIpAddress : public ::google::protobuf::Message {
 public:
  SLIpAddress();
  virtual ~SLIpAddress();
  ...
  inline SLIpAddress* New() const { return New(NULL); }

  SLIpAddress* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  inline void set_has_v4address();
  inline void set_has_v6address();
  ...
  void InitAsDefaultInstance();
  static SLIpAddress* default_instance_;
};
// ===================================================================
...
inline const ::std::string& SLInterface::name() const {
  ...
  if (has_name()) {
    return Interface_.name_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  }
...
inline const ::std::string& SLIpAddress::v6address() const {
  ...
  if (has_v6address()) {
    return Address_.v6address_.GetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  }
  return *&::google::protobuf::internal::GetEmptyStringAlreadyInited();
}
