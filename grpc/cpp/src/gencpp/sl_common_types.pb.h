...
enum SLErrorStatus_SLErrno : int {
  ...
  SLErrorStatus_SLErrno_SL_SRTE_POLICY_START_OFFSET = 106496,
  SLErrorStatus_SLErrno_SL_SRTE_POLICY_INVALID_REQUEST = 106497,
  SLErrorStatus_SLErrno_SL_SRTE_POLICY_POLICYKEY_MISSING = 106498,
  SLErrorStatus_SLErrno_SL_SRTE_POLICY_POLICYKEY_COLOR_MISSING = 106499,
  SLErrorStatus_SLErrno_SL_SRTE_POLICY_POLICYKEY_EP_MISSING = 106500,
  SLErrorStatus_SLErrno_SL_SRTE_POLICY_POLICYKEY_SRC_MISSING = 106501,
  SLErrorStatus_SLErrno_SL_SRTE_POLICY_CP_PREF_MISSING = 106502,
  SLErrorStatus_SLErrno_SL_SRTE_POLICY_CPKEY_MISSING = 106503,
  SLErrorStatus_SLErrno_SL_SRTE_POLICY_CPKEY_ORIGINATOR_MISSING = 106504,
  SLErrorStatus_SLErrno_SL_SRTE_POLICY_SERVICE_NOT_UP = 106505,
  SLErrorStatus_SLErrno_SL_SRTE_POLICY_EXCEED_MSG_SIZE = 106506,
  SLErrorStatus_SLErrno_SL_SRTE_PCALC_INVALID_REQUEST = 106753,
  SLErrorStatus_SLErrno_SL_SRTE_PCALC_NO_PATH_FOUND = 106754,
...
class SLErrorStatus final :
 ...
 public:
  ...
  static constexpr SLErrno SL_SRTE_POLICY_INVALID_REQUEST =
    SLErrorStatus_SLErrno_SL_SRTE_POLICY_INVALID_REQUEST;
  static constexpr SLErrno SL_SRTE_POLICY_POLICYKEY_MISSING =
    SLErrorStatus_SLErrno_SL_SRTE_POLICY_POLICYKEY_MISSING;
  static constexpr SLErrno SL_SRTE_POLICY_POLICYKEY_COLOR_MISSING =
    SLErrorStatus_SLErrno_SL_SRTE_POLICY_POLICYKEY_COLOR_MISSING;
  static constexpr SLErrno SL_SRTE_POLICY_POLICYKEY_EP_MISSING =
    SLErrorStatus_SLErrno_SL_SRTE_POLICY_POLICYKEY_EP_MISSING;
  static constexpr SLErrno SL_SRTE_POLICY_POLICYKEY_SRC_MISSING =
    SLErrorStatus_SLErrno_SL_SRTE_POLICY_POLICYKEY_SRC_MISSING;
  static constexpr SLErrno SL_SRTE_POLICY_CP_PREF_MISSING =
    SLErrorStatus_SLErrno_SL_SRTE_POLICY_CP_PREF_MISSING;
  static constexpr SLErrno SL_SRTE_POLICY_CPKEY_MISSING =
    SLErrorStatus_SLErrno_SL_SRTE_POLICY_CPKEY_MISSING;
  static constexpr SLErrno SL_SRTE_POLICY_CPKEY_ORIGINATOR_MISSING =
    SLErrorStatus_SLErrno_SL_SRTE_POLICY_CPKEY_ORIGINATOR_MISSING;
  ...
  static constexpr SLErrno SL_SRTE_PCALC_INVALID_REQUEST =
    SLErrorStatus_SLErrno_SL_SRTE_PCALC_INVALID_REQUEST;
  static constexpr SLErrno SL_SRTE_PCALC_NO_PATH_FOUND =
    SLErrorStatus_SLErrno_SL_SRTE_PCALC_NO_PATH_FOUND;
