...
enum SLErrorStatus_SLErrno : int {
  ...
  SLErrorStatus_SLErrno_SL_RPC_ROUTE_GET_FILTER_INVALID = 12299,
  SLErrorStatus_SLErrno_SL_RPC_ROUTE_GET_FILTER_NOTSUP = 12300,
...
class SLErrorStatus final :
 ...
 public:
  ...
  static constexpr SLErrno SL_RPC_ROUTE_GET_FILTER_INVALID =
    SLErrorStatus_SLErrno_SL_RPC_ROUTE_GET_FILTER_INVALID;
  static constexpr SLErrno SL_RPC_ROUTE_GET_FILTER_NOTSUP =
    SLErrorStatus_SLErrno_SL_RPC_ROUTE_GET_FILTER_NOTSUP;
