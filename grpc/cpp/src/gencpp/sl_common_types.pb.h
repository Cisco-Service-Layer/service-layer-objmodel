...
enum SLEncapType {
  ...
  SL_ENCAP_VXLAN = 1,
  SL_ENCAP_MPLS = 2,
  SLEncapType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  SLEncapType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool SLEncapType_IsValid(int value);
const SLEncapType SLEncapType_MIN = SL_ENCAP_RESERVED;
const SLEncapType SLEncapType_MAX = SL_ENCAP_MPLS;
const int SLEncapType_ARRAYSIZE = SLEncapType_MAX + 1;

const ::google::protobuf::EnumDescriptor* SLEncapType_descriptor();
inline const ::std::string& SLEncapType_Name(SLEncapType value) {
  return ::google::protobuf::internal::NameOfEnum(
    SLEncapType_descriptor(), value);
}
inline bool SLEncapType_Parse(
    const ::std::string& name, SLEncapType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<SLEncapType>(
...
class SLErrorStatus : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:service_layer.SLErrorStatus) */ {
 public:
  ...
  static const SLErrno SL_VRF_V4_ROUTE_REPLAY_OK =
    SLErrorStatus_SLErrno_SL_VRF_V4_ROUTE_REPLAY_OK;
  static const SLErrno SL_VRF_V6_ROUTE_REPLAY_OK =
  ...
  static const SLErrno SL_RPC_ROUTE_NOTIF_SRC_PROTO_TOOLONG =
    SLErrorStatus_SLErrno_SL_RPC_ROUTE_NOTIF_SRC_PROTO_TOOLONG;
  static const SLErrno SL_RPC_ROUTE_NOTIF_SRC_PROTO_TAG_TOOLONG =
  ...
  static const SLErrno SL_PATH_ROUTER_MAC_ADDR_INVALID_SZ =
  ...
  static const SLErrno SL_ILM_ELSP_EXP_OR_DFLT_ALREADY_SET =
    SLErrorStatus_SLErrno_SL_ILM_ELSP_EXP_OR_DFLT_ALREADY_SET;
  static const SLErrno SL_ILM_ADD_NO_PATHS =
    SLErrorStatus_SLErrno_SL_ILM_ADD_NO_PATHS;
  static const SLErrno SL_ILM_UPDATE_NO_PATHS =
  ...
  static const SLErrno SL_ILM_REPLAY_OK =
  ...
  static const SLErrno SL_NHLFE_EXP_SET_FAILED =
    SLErrorStatus_SLErrno_SL_NHLFE_EXP_SET_FAILED;
  static const SLErrno SL_NHLFE_ELSP_PROTECTION_UNSUPPORTED =
  ...
  static const SLErrno SL_LABEL_BLK_TYPE_INVALID =
    SLErrorStatus_SLErrno_SL_LABEL_BLK_TYPE_INVALID;
  static const SLErrno SL_LABEL_BLK_CLIENT_NAME_TOOLONG =
  ...
  static const SLErrno SL_L2_REG_START_OFFSET =
    SLErrorStatus_SLErrno_SL_L2_REG_START_OFFSET;
  static const SLErrno SL_L2_REGISTRATION_ERR =
    SLErrorStatus_SLErrno_SL_L2_REGISTRATION_ERR;
  static const SLErrno SL_L2_UNREGISTRATION_ERR =
    SLErrorStatus_SLErrno_SL_L2_UNREGISTRATION_ERR;
  static const SLErrno SL_L2_EOF_ERR =
    SLErrorStatus_SLErrno_SL_L2_EOF_ERR;
  static const SLErrno SL_L2_REG_INVALID_ADMIN_DISTANCE =
    SLErrorStatus_SLErrno_SL_L2_REG_INVALID_ADMIN_DISTANCE;
  static const SLErrno SL_L2_REG_IS_DUPLICATE =
    SLErrorStatus_SLErrno_SL_L2_REG_IS_DUPLICATE;
  static const SLErrno SL_L2_REG_SERVER_NOT_INITIALIZED =
    SLErrorStatus_SLErrno_SL_L2_REG_SERVER_NOT_INITIALIZED;
  static const SLErrno SL_RPC_L2_BD_REG_START_OFFSET =
    SLErrorStatus_SLErrno_SL_RPC_L2_BD_REG_START_OFFSET;
  static const SLErrno SL_RPC_L2_BD_REG_NAME_MISSING =
    SLErrorStatus_SLErrno_SL_RPC_L2_BD_REG_NAME_MISSING;
  static const SLErrno SL_RPC_L2_BD_REG_TOO_MANY_MSGS =
    SLErrorStatus_SLErrno_SL_RPC_L2_BD_REG_TOO_MANY_MSGS;
  static const SLErrno SL_RPC_L2_BD_REG_SERVER_NOT_INITIALIZED =
    SLErrorStatus_SLErrno_SL_RPC_L2_BD_REG_SERVER_NOT_INITIALIZED;
  static const SLErrno SL_RPC_L2_BD_REG_CLIENT_NOT_REGISTERED =
    SLErrorStatus_SLErrno_SL_RPC_L2_BD_REG_CLIENT_NOT_REGISTERED;
  static const SLErrno SL_L2_BD_REG_START_OFFSET =
    SLErrorStatus_SLErrno_SL_L2_BD_REG_START_OFFSET;
  static const SLErrno SL_L2_BD_REGISTRATION_ERR =
    SLErrorStatus_SLErrno_SL_L2_BD_REGISTRATION_ERR;
  static const SLErrno SL_L2_BD_UNREGISTRATION_ERR =
    SLErrorStatus_SLErrno_SL_L2_BD_UNREGISTRATION_ERR;
  static const SLErrno SL_L2_BD_EOF_ERR =
    SLErrorStatus_SLErrno_SL_L2_BD_EOF_ERR;
  static const SLErrno SL_L2_BD_REG_NAME_TOO_LONG =
    SLErrorStatus_SLErrno_SL_L2_BD_REG_NAME_TOO_LONG;
  static const SLErrno SL_L2_BD_REG_BD_NOT_FOUND =
    SLErrorStatus_SLErrno_SL_L2_BD_REG_BD_NOT_FOUND;
  static const SLErrno SL_RPC_L2_ROUTE_START_OFFSET =
    SLErrorStatus_SLErrno_SL_RPC_L2_ROUTE_START_OFFSET;
  static const SLErrno SL_RPC_L2_ROUTE_TOO_MANY_MSGS =
    SLErrorStatus_SLErrno_SL_RPC_L2_ROUTE_TOO_MANY_MSGS;
  static const SLErrno SL_RPC_L2_ROUTE_SERVER_NOT_INITIALIZED =
    SLErrorStatus_SLErrno_SL_RPC_L2_ROUTE_SERVER_NOT_INITIALIZED;
  static const SLErrno SL_RPC_L2_ROUTE_CLIENT_NOT_REGISTERED =
    SLErrorStatus_SLErrno_SL_RPC_L2_ROUTE_CLIENT_NOT_REGISTERED;
  static const SLErrno SL_L2_ROUTE_START_OFFSET =
    SLErrorStatus_SLErrno_SL_L2_ROUTE_START_OFFSET;
  static const SLErrno SL_L2_ROUTE_BD_NAME_MISSING =
    SLErrorStatus_SLErrno_SL_L2_ROUTE_BD_NAME_MISSING;
  static const SLErrno SL_L2_ROUTE_BD_NAME_TOOLONG =
    SLErrorStatus_SLErrno_SL_L2_ROUTE_BD_NAME_TOOLONG;
  static const SLErrno SL_L2_ROUTE_BD_NOT_FOUND =
    SLErrorStatus_SLErrno_SL_L2_ROUTE_BD_NOT_FOUND;
  static const SLErrno SL_L2_ROUTE_BD_NOT_REGISTERED =
    SLErrorStatus_SLErrno_SL_L2_ROUTE_BD_NOT_REGISTERED;
  static const SLErrno SL_L2_ROUTE_INVALID_ARGS =
    SLErrorStatus_SLErrno_SL_L2_ROUTE_INVALID_ARGS;
  static const SLErrno SL_RPC_L2_NOTIF_START_OFFSET =
    SLErrorStatus_SLErrno_SL_RPC_L2_NOTIF_START_OFFSET;
  static const SLErrno SL_RPC_L2_NOTIF_SERVER_NOT_INITIALIZED =
    SLErrorStatus_SLErrno_SL_RPC_L2_NOTIF_SERVER_NOT_INITIALIZED;
  static const SLErrno SL_RPC_L2_NOTIF_CLIENT_NOT_REGISTERED =
    SLErrorStatus_SLErrno_SL_RPC_L2_NOTIF_CLIENT_NOT_REGISTERED;
  static const SLErrno SL_RPC_L2_NOTIF_ENABLE_ERR =
    SLErrorStatus_SLErrno_SL_RPC_L2_NOTIF_ENABLE_ERR;
  static const SLErrno SL_RPC_L2_NOTIF_DISABLE_ERR =
    SLErrorStatus_SLErrno_SL_RPC_L2_NOTIF_DISABLE_ERR;
  static const SLErrno SL_RPC_L2_NOTIF_EOF_ERR =
    SLErrorStatus_SLErrno_SL_RPC_L2_NOTIF_EOF_ERR;
  static const SLErrno SL_RPC_L2_NOTIF_BD_NAME_MISSING =
    SLErrorStatus_SLErrno_SL_RPC_L2_NOTIF_BD_NAME_MISSING;
  static const SLErrno SL_RPC_L2_NOTIF_BD_NAME_TOOLONG =
    SLErrorStatus_SLErrno_SL_RPC_L2_NOTIF_BD_NAME_TOOLONG;
  static const SLErrno SL_RPC_L2_NOTIF_BD_NOT_FOUND =
...
template <> struct is_proto_enum< ::service_layer::SLEncapType> : ::google::protobuf::internal::true_type {};
template <>
