...
enum SLErrorStatus_SLErrno : int {
  ...
  SLErrorStatus_SLErrno_SL_NHLFE_NON_CONTIGUOUS_ELSPS = 40995,
  SLErrorStatus_SLErrno_SL_NHLFE_INCONSISTENT_ELSP_ON_PATH = 40996,
...
class SLErrorStatus final :
 ...
 public:
  ...
  static constexpr SLErrno SL_NHLFE_NON_CONTIGUOUS_ELSPS =
    SLErrorStatus_SLErrno_SL_NHLFE_NON_CONTIGUOUS_ELSPS;
  static constexpr SLErrno SL_NHLFE_INCONSISTENT_ELSP_ON_PATH =
    SLErrorStatus_SLErrno_SL_NHLFE_INCONSISTENT_ELSP_ON_PATH;
