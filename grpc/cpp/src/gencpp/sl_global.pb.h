...
class SLVrfRouteReplayErrorNotif final :
 ...
 public:
  ...
  inline SLVrfRouteReplayErrorNotif* New() const final {
    return new SLVrfRouteReplayErrorNotif();
  }
...
class SLGlobalNotif final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::service_layer::SLInitMsgRsp* release_initrspmsg();
  ...
  PROTOBUF_MUST_USE_RESULT ::service_layer::SLVrfRouteReplayErrorNotif* release_vrfreplayerrornotif();
