...
inline void InitDefaults() {
  ...
  InitDefaultsSLRoutev4NotifRoute();
  InitDefaultsSLRoutev4Notif();
}
}  // namespace protobuf_sl_5froute_5fipv4_2eproto
...
class SLRoutev4NotifRoute : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:service_layer.SLRoutev4NotifRoute) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_sl_5froute_5fipv4_2eproto::TableStruct;
  friend void ::protobuf_sl_5froute_5fipv4_2eproto::InitDefaultsSLRoutev4NotifRouteImpl();
};
// -------------------------------------------------------------------
...
class SLRoutev4Notif : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:service_layer.SLRoutev4Notif) */ {
 ...
 private:
  ...
  friend struct ::protobuf_sl_5froute_5fipv4_2eproto::TableStruct;
  friend void ::protobuf_sl_5froute_5fipv4_2eproto::InitDefaultsSLRoutev4NotifImpl();
};
// ===================================================================
