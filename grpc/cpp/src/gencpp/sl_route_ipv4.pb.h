...
class SLRoutev4 final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::service_layer::SLRouteCommon* release_routecommon();
...
class SLRoutev4NotifRoute final :
 ...
 public:
  ...
  inline SLRoutev4NotifRoute* New() const final {
    return new SLRoutev4NotifRoute();
  }
...
class SLRoutev4Notif final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::service_layer::SLRouteNotifStatus* release_notifstatus();
  ...
  PROTOBUF_MUST_USE_RESULT ::service_layer::SLRoutev4NotifRoute* release_route();
  ...
  PROTOBUF_MUST_USE_RESULT ::service_layer::SLRouteNotifMarker* release_marker();
  ...
  PROTOBUF_MUST_USE_RESULT ::service_layer::SLVrfNotif* release_vrf();
