...
class SLRoutev6NotifRoute final :
 ...
 public:
  ...
  inline SLRoutev6NotifRoute* New() const final {
    return new SLRoutev6NotifRoute();
  }
...
class SLRoutev6Notif final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::service_layer::SLRoutev6NotifRoute* release_route();
