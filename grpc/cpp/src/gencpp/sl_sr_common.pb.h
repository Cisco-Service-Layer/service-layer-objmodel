...
extern SLSRv6SIDInfoDefaultTypeInternal _SLSRv6SIDInfo_default_instance_;
...
class SLSrSegmentRules;
struct SLSrSegmentRulesDefaultTypeInternal;
extern SLSrSegmentRulesDefaultTypeInternal _SLSrSegmentRules_default_instance_;
class SLSrStatus;
struct SLSrStatusDefaultTypeInternal;
extern SLSrStatusDefaultTypeInternal _SLSrStatus_default_instance_;
class SLSrUpperBoundConstraints;
struct SLSrUpperBoundConstraintsDefaultTypeInternal;
extern SLSrUpperBoundConstraintsDefaultTypeInternal _SLSrUpperBoundConstraints_default_instance_;
class SLSrteSegment;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::service_layer::SLSRv6SIDInfo* Arena::CreateMaybeMessage<::service_layer::SLSRv6SIDInfo>(Arena*);
...
template<> ::service_layer::SLSrSegmentRules* Arena::CreateMaybeMessage<::service_layer::SLSrSegmentRules>(Arena*);
template<> ::service_layer::SLSrStatus* Arena::CreateMaybeMessage<::service_layer::SLSrStatus>(Arena*);
template<> ::service_layer::SLSrUpperBoundConstraints* Arena::CreateMaybeMessage<::service_layer::SLSrUpperBoundConstraints>(Arena*);
...
template<typename T>
inline const std::string& SLSrteProtectionType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, SLSrteProtectionType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function SLSrteProtectionType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    SLSrteProtectionType_descriptor(), enum_t_value);
}
inline bool SLSrteProtectionType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, SLSrteProtectionType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<SLSrteProtectionType>(
    SLSrteProtectionType_descriptor(), name, value);
}
// ===================================================================
...
class SLSrCandidatePathKey_Originator final :
 ...
 public:
  ...
  public:
  void clear_asn();
  const ::service_layer::SLAutonomousSystemNumber& asn() const;
  PROTOBUF_NODISCARD ::service_layer::SLAutonomousSystemNumber* release_asn();
  ::service_layer::SLAutonomousSystemNumber* mutable_asn();
  void set_allocated_asn(::service_layer::SLAutonomousSystemNumber* asn);
  private:
  const ::service_layer::SLAutonomousSystemNumber& _internal_asn() const;
  ::service_layer::SLAutonomousSystemNumber* _internal_mutable_asn();
  public:
  void unsafe_arena_set_allocated_asn(
      ::service_layer::SLAutonomousSystemNumber* asn);
  ::service_layer::SLAutonomousSystemNumber* unsafe_arena_release_asn();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::service_layer::SLAutonomousSystemNumber* asn_;
...
class SLSrSegmentRules final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:service_layer.SLSrSegmentRules) */ {
 public:
  inline SLSrSegmentRules() : SLSrSegmentRules(nullptr) {}
  ~SLSrSegmentRules() override;
  explicit constexpr SLSrSegmentRules(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SLSrSegmentRules(const SLSrSegmentRules& from);
  SLSrSegmentRules(SLSrSegmentRules&& from) noexcept
    : SLSrSegmentRules() {
    *this = ::std::move(from);
  }

  inline SLSrSegmentRules& operator=(const SLSrSegmentRules& from) {
    CopyFrom(from);
    return *this;
  }
  inline SLSrSegmentRules& operator=(SLSrSegmentRules&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const SLSrSegmentRules& default_instance() {
    return *internal_default_instance();
  }
  static inline const SLSrSegmentRules* internal_default_instance() {
    return reinterpret_cast<const SLSrSegmentRules*>(
               &_SLSrSegmentRules_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    12;

  friend void swap(SLSrSegmentRules& a, SLSrSegmentRules& b) {
    a.Swap(&b);
  }
  inline void Swap(SLSrSegmentRules* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(SLSrSegmentRules* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  SLSrSegmentRules* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SLSrSegmentRules>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const SLSrSegmentRules& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const SLSrSegmentRules& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(SLSrSegmentRules* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "service_layer.SLSrSegmentRules";
  }
  protected:
  explicit SLSrSegmentRules(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  // @@protoc_insertion_point(class_scope:service_layer.SLSrSegmentRules)
 private:
  class _Internal;
...
class SLSrUpperBoundConstraints final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:service_layer.SLSrUpperBoundConstraints) */ {
 public:
  inline SLSrUpperBoundConstraints() : SLSrUpperBoundConstraints(nullptr) {}
  ~SLSrUpperBoundConstraints() override;
  explicit constexpr SLSrUpperBoundConstraints(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SLSrUpperBoundConstraints(const SLSrUpperBoundConstraints& from);
  SLSrUpperBoundConstraints(SLSrUpperBoundConstraints&& from) noexcept
    : SLSrUpperBoundConstraints() {
    *this = ::std::move(from);
  }

  inline SLSrUpperBoundConstraints& operator=(const SLSrUpperBoundConstraints& from) {
    CopyFrom(from);
    return *this;
  }
  inline SLSrUpperBoundConstraints& operator=(SLSrUpperBoundConstraints&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const SLSrUpperBoundConstraints& default_instance() {
    return *internal_default_instance();
  }
  static inline const SLSrUpperBoundConstraints* internal_default_instance() {
    return reinterpret_cast<const SLSrUpperBoundConstraints*>(
               &_SLSrUpperBoundConstraints_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    13;

  friend void swap(SLSrUpperBoundConstraints& a, SLSrUpperBoundConstraints& b) {
    a.Swap(&b);
  }
  inline void Swap(SLSrUpperBoundConstraints* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(SLSrUpperBoundConstraints* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  SLSrUpperBoundConstraints* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SLSrUpperBoundConstraints>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const SLSrUpperBoundConstraints& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const SLSrUpperBoundConstraints& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(SLSrUpperBoundConstraints* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "service_layer.SLSrUpperBoundConstraints";
  }
  protected:
  explicit SLSrUpperBoundConstraints(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  // @@protoc_insertion_point(class_scope:service_layer.SLSrUpperBoundConstraints)
 private:
  class _Internal;
...
class SLSRv6SIDInfo final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:service_layer.SLSRv6SIDInfo) */ {
 public:
  inline SLSRv6SIDInfo() : SLSRv6SIDInfo(nullptr) {}
  ~SLSRv6SIDInfo() override;
  explicit constexpr SLSRv6SIDInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SLSRv6SIDInfo(const SLSRv6SIDInfo& from);
  SLSRv6SIDInfo(SLSRv6SIDInfo&& from) noexcept
    : SLSRv6SIDInfo() {
    *this = ::std::move(from);
  }

  inline SLSRv6SIDInfo& operator=(const SLSRv6SIDInfo& from) {
    CopyFrom(from);
    return *this;
  }
  inline SLSRv6SIDInfo& operator=(SLSRv6SIDInfo&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const SLSRv6SIDInfo& default_instance() {
    return *internal_default_instance();
  }
  static inline const SLSRv6SIDInfo* internal_default_instance() {
    return reinterpret_cast<const SLSRv6SIDInfo*>(
               &_SLSRv6SIDInfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    14;

  friend void swap(SLSRv6SIDInfo& a, SLSRv6SIDInfo& b) {
    a.Swap(&b);
  }
  inline void Swap(SLSRv6SIDInfo* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(SLSRv6SIDInfo* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  SLSRv6SIDInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SLSRv6SIDInfo>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const SLSRv6SIDInfo& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const SLSRv6SIDInfo& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(SLSRv6SIDInfo* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "service_layer.SLSRv6SIDInfo";
  }
  protected:
  explicit SLSRv6SIDInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  enum : int {
    kSidAddressFieldNumber = 1,
    kStructureFieldNumber = 3,
    kBehaviorFieldNumber = 2,
  };
  // .service_layer.SLIpv6Address sid_address = 1;
  bool has_sid_address() const;
  private:
  bool _internal_has_sid_address() const;
  public:
  void clear_sid_address();
  const ::service_layer::SLIpv6Address& sid_address() const;
  PROTOBUF_NODISCARD ::service_layer::SLIpv6Address* release_sid_address();
  ::service_layer::SLIpv6Address* mutable_sid_address();
  void set_allocated_sid_address(::service_layer::SLIpv6Address* sid_address);
  private:
  const ::service_layer::SLIpv6Address& _internal_sid_address() const;
  ::service_layer::SLIpv6Address* _internal_mutable_sid_address();
  public:
  void unsafe_arena_set_allocated_sid_address(
      ::service_layer::SLIpv6Address* sid_address);
  ::service_layer::SLIpv6Address* unsafe_arena_release_sid_address();
  ...
  // @@protoc_insertion_point(class_scope:service_layer.SLSRv6SIDInfo)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::service_layer::SLIpv6Address* sid_address_;
...
class SLSrteSegment_TypeB final :
 ...
 public:
  ...
  // .service_layer.SLSRv6SIDInfo srv6_sid = 1;
  bool has_srv6_sid() const;
  private:
  bool _internal_has_srv6_sid() const;
  public:
  void clear_srv6_sid();
  const ::service_layer::SLSRv6SIDInfo& srv6_sid() const;
  PROTOBUF_NODISCARD ::service_layer::SLSRv6SIDInfo* release_srv6_sid();
  ::service_layer::SLSRv6SIDInfo* mutable_srv6_sid();
  void set_allocated_srv6_sid(::service_layer::SLSRv6SIDInfo* srv6_sid);
  private:
  const ::service_layer::SLSRv6SIDInfo& _internal_srv6_sid() const;
  ::service_layer::SLSRv6SIDInfo* _internal_mutable_srv6_sid();
  public:
  void unsafe_arena_set_allocated_srv6_sid(
      ::service_layer::SLSRv6SIDInfo* srv6_sid);
  ::service_layer::SLSRv6SIDInfo* unsafe_arena_release_srv6_sid();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::service_layer::SLSRv6SIDInfo* srv6_sid_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_sl_5fsr_5fcommon_2eproto;
};
// -------------------------------------------------------------------
...
class SLSrStatus final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:service_layer.SLSrStatus) */ {
 public:
  inline SLSrStatus() : SLSrStatus(nullptr) {}
  ~SLSrStatus() override;
  explicit constexpr SLSrStatus(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SLSrStatus(const SLSrStatus& from);
  SLSrStatus(SLSrStatus&& from) noexcept
    : SLSrStatus() {
    *this = ::std::move(from);
  }

  inline SLSrStatus& operator=(const SLSrStatus& from) {
    CopyFrom(from);
    return *this;
  }
  inline SLSrStatus& operator=(SLSrStatus&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const SLSrStatus& default_instance() {
    return *internal_default_instance();
  }
  static inline const SLSrStatus* internal_default_instance() {
    return reinterpret_cast<const SLSrStatus*>(
               &_SLSrStatus_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    19;

  friend void swap(SLSrStatus& a, SLSrStatus& b) {
    a.Swap(&b);
  }
  inline void Swap(SLSrStatus* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(SLSrStatus* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  SLSrStatus* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SLSrStatus>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const SLSrStatus& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const SLSrStatus& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(SLSrStatus* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "service_layer.SLSrStatus";
  }
  protected:
  explicit SLSrStatus(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  // @@protoc_insertion_point(class_scope:service_layer.SLSrStatus)
 private:
  class _Internal;
...
// .service_layer.SLAutonomousSystemNumber asn = 1;
inline bool SLSrCandidatePathKey_Originator::_internal_has_asn() const {
  return this != internal_default_instance() && asn_ != nullptr;
}
inline bool SLSrCandidatePathKey_Originator::has_asn() const {
  return _internal_has_asn();
}
inline const ::service_layer::SLAutonomousSystemNumber& SLSrCandidatePathKey_Originator::_internal_asn() const {
  const ::service_layer::SLAutonomousSystemNumber* p = asn_;
  return p != nullptr ? *p : reinterpret_cast<const ::service_layer::SLAutonomousSystemNumber&>(
      ::service_layer::_SLAutonomousSystemNumber_default_instance_);
}
inline const ::service_layer::SLAutonomousSystemNumber& SLSrCandidatePathKey_Originator::asn() const {
  // @@protoc_insertion_point(field_get:service_layer.SLSrCandidatePathKey.Originator.asn)
  return _internal_asn();
}
inline void SLSrCandidatePathKey_Originator::unsafe_arena_set_allocated_asn(
    ::service_layer::SLAutonomousSystemNumber* asn) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:service_layer.SLSrCandidatePathKey.Originator.asn)
}
inline ::service_layer::SLAutonomousSystemNumber* SLSrCandidatePathKey_Originator::release_asn() {
  
  ::service_layer::SLAutonomousSystemNumber* temp = asn_;
  asn_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::service_layer::SLAutonomousSystemNumber* SLSrCandidatePathKey_Originator::unsafe_arena_release_asn() {
  // @@protoc_insertion_point(field_release:service_layer.SLSrCandidatePathKey.Originator.asn)
  
  ::service_layer::SLAutonomousSystemNumber* temp = asn_;
  asn_ = nullptr;
  return temp;
}
inline ::service_layer::SLAutonomousSystemNumber* SLSrCandidatePathKey_Originator::_internal_mutable_asn() {
  
  if (asn_ == nullptr) {
    auto* p = CreateMaybeMessage<::service_layer::SLAutonomousSystemNumber>(GetArenaForAllocation());
    asn_ = p;
  }
  return asn_;
}
inline ::service_layer::SLAutonomousSystemNumber* SLSrCandidatePathKey_Originator::mutable_asn() {
  ::service_layer::SLAutonomousSystemNumber* _msg = _internal_mutable_asn();
  // @@protoc_insertion_point(field_mutable:service_layer.SLSrCandidatePathKey.Originator.asn)
  return _msg;
}
inline void SLSrCandidatePathKey_Originator::set_allocated_asn(::service_layer::SLAutonomousSystemNumber* asn) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(asn_);
  }
  if (asn) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(asn));
    if (message_arena != submessage_arena) {
  ...
  asn_ = asn;
  // @@protoc_insertion_point(field_set_allocated:service_layer.SLSrCandidatePathKey.Originator.asn)
}
...
// optional uint32 sid_algo = 1;
inline bool SLSrSegmentRules::_internal_has_sid_algo() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool SLSrSegmentRules::has_sid_algo() const {
  return _internal_has_sid_algo();
}
inline void SLSrSegmentRules::clear_sid_algo() {
  sid_algo_ = 0u;
  _has_bits_[0] &= ~0x00000001u;
}
inline uint32_t SLSrSegmentRules::_internal_sid_algo() const {
  return sid_algo_;
}
inline uint32_t SLSrSegmentRules::sid_algo() const {
  // @@protoc_insertion_point(field_get:service_layer.SLSrSegmentRules.sid_algo)
  return _internal_sid_algo();
}
inline void SLSrSegmentRules::_internal_set_sid_algo(uint32_t value) {
  _has_bits_[0] |= 0x00000001u;
  sid_algo_ = value;
}
inline void SLSrSegmentRules::set_sid_algo(uint32_t value) {
  _internal_set_sid_algo(value);
  // @@protoc_insertion_point(field_set:service_layer.SLSrSegmentRules.sid_algo)
}

// .service_layer.SLSrteProtectionType protection = 2;
inline void SLSrSegmentRules::clear_protection() {
  protection_ = 0;
}
inline ::service_layer::SLSrteProtectionType SLSrSegmentRules::_internal_protection() const {
  return static_cast< ::service_layer::SLSrteProtectionType >(protection_);
}
inline ::service_layer::SLSrteProtectionType SLSrSegmentRules::protection() const {
  // @@protoc_insertion_point(field_get:service_layer.SLSrSegmentRules.protection)
  return _internal_protection();
}
inline void SLSrSegmentRules::_internal_set_protection(::service_layer::SLSrteProtectionType value) {
  
  protection_ = value;
}
inline void SLSrSegmentRules::set_protection(::service_layer::SLSrteProtectionType value) {
  _internal_set_protection(value);
  // @@protoc_insertion_point(field_set:service_layer.SLSrSegmentRules.protection)
}
...
// uint32 maximum_sid_depth = 1;
inline void SLSrUpperBoundConstraints::clear_maximum_sid_depth() {
  maximum_sid_depth_ = 0u;
}
inline uint32_t SLSrUpperBoundConstraints::_internal_maximum_sid_depth() const {
  return maximum_sid_depth_;
}
inline uint32_t SLSrUpperBoundConstraints::maximum_sid_depth() const {
  // @@protoc_insertion_point(field_get:service_layer.SLSrUpperBoundConstraints.maximum_sid_depth)
  return _internal_maximum_sid_depth();
}
inline void SLSrUpperBoundConstraints::_internal_set_maximum_sid_depth(uint32_t value) {
  
  maximum_sid_depth_ = value;
}
inline void SLSrUpperBoundConstraints::set_maximum_sid_depth(uint32_t value) {
  _internal_set_maximum_sid_depth(value);
  // @@protoc_insertion_point(field_set:service_layer.SLSrUpperBoundConstraints.maximum_sid_depth)
}
...
// .service_layer.SLIpv6Address sid_address = 1;
inline bool SLSRv6SIDInfo::_internal_has_sid_address() const {
  return this != internal_default_instance() && sid_address_ != nullptr;
}
inline bool SLSRv6SIDInfo::has_sid_address() const {
  return _internal_has_sid_address();
}
inline const ::service_layer::SLIpv6Address& SLSRv6SIDInfo::_internal_sid_address() const {
  const ::service_layer::SLIpv6Address* p = sid_address_;
  return p != nullptr ? *p : reinterpret_cast<const ::service_layer::SLIpv6Address&>(
      ::service_layer::_SLIpv6Address_default_instance_);
}
inline const ::service_layer::SLIpv6Address& SLSRv6SIDInfo::sid_address() const {
  // @@protoc_insertion_point(field_get:service_layer.SLSRv6SIDInfo.sid_address)
  return _internal_sid_address();
}
inline void SLSRv6SIDInfo::unsafe_arena_set_allocated_sid_address(
    ::service_layer::SLIpv6Address* sid_address) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(sid_address_);
  }
  sid_address_ = sid_address;
  if (sid_address) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:service_layer.SLSRv6SIDInfo.sid_address)
}
inline ::service_layer::SLIpv6Address* SLSRv6SIDInfo::release_sid_address() {
  
  ::service_layer::SLIpv6Address* temp = sid_address_;
...
inline ::service_layer::SLIpv6Address* SLSRv6SIDInfo::unsafe_arena_release_sid_address() {
  // @@protoc_insertion_point(field_release:service_layer.SLSRv6SIDInfo.sid_address)
  
  ::service_layer::SLIpv6Address* temp = sid_address_;
  sid_address_ = nullptr;
  return temp;
}
inline ::service_layer::SLIpv6Address* SLSRv6SIDInfo::_internal_mutable_sid_address() {
  
  if (sid_address_ == nullptr) {
    auto* p = CreateMaybeMessage<::service_layer::SLIpv6Address>(GetArenaForAllocation());
    sid_address_ = p;
  }
  return sid_address_;
}
inline ::service_layer::SLIpv6Address* SLSRv6SIDInfo::mutable_sid_address() {
  ::service_layer::SLIpv6Address* _msg = _internal_mutable_sid_address();
  // @@protoc_insertion_point(field_mutable:service_layer.SLSRv6SIDInfo.sid_address)
  return _msg;
}
inline void SLSRv6SIDInfo::set_allocated_sid_address(::service_layer::SLIpv6Address* sid_address) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(sid_address_);
  }
  if (sid_address) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<
            ::PROTOBUF_NAMESPACE_ID::MessageLite>::GetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(sid_address));
    if (message_arena != submessage_arena) {
      sid_address = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, sid_address, submessage_arena);
    }
  ...
  sid_address_ = sid_address;
  // @@protoc_insertion_point(field_set_allocated:service_layer.SLSRv6SIDInfo.sid_address)
}

// uint32 behavior = 2;
inline void SLSRv6SIDInfo::clear_behavior() {
  behavior_ = 0u;
}
inline uint32_t SLSRv6SIDInfo::_internal_behavior() const {
  return behavior_;
}
inline uint32_t SLSRv6SIDInfo::behavior() const {
  // @@protoc_insertion_point(field_get:service_layer.SLSRv6SIDInfo.behavior)
  return _internal_behavior();
}
inline void SLSRv6SIDInfo::_internal_set_behavior(uint32_t value) {
  
  behavior_ = value;
}
inline void SLSRv6SIDInfo::set_behavior(uint32_t value) {
  _internal_set_behavior(value);
  // @@protoc_insertion_point(field_set:service_layer.SLSRv6SIDInfo.behavior)
}

// .service_layer.SLSrv6SidStruct structure = 3;
inline bool SLSRv6SIDInfo::_internal_has_structure() const {
  return this != internal_default_instance() && structure_ != nullptr;
}
inline bool SLSRv6SIDInfo::has_structure() const {
  return _internal_has_structure();
}
inline void SLSRv6SIDInfo::clear_structure() {
  if (GetArenaForAllocation() == nullptr && structure_ != nullptr) {
    delete structure_;
  }
  structure_ = nullptr;
}
inline const ::service_layer::SLSrv6SidStruct& SLSRv6SIDInfo::_internal_structure() const {
  const ::service_layer::SLSrv6SidStruct* p = structure_;
  return p != nullptr ? *p : reinterpret_cast<const ::service_layer::SLSrv6SidStruct&>(
      ::service_layer::_SLSrv6SidStruct_default_instance_);
}
inline const ::service_layer::SLSrv6SidStruct& SLSRv6SIDInfo::structure() const {
  // @@protoc_insertion_point(field_get:service_layer.SLSRv6SIDInfo.structure)
  return _internal_structure();
}
inline void SLSRv6SIDInfo::unsafe_arena_set_allocated_structure(
    ::service_layer::SLSrv6SidStruct* structure) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:service_layer.SLSRv6SIDInfo.structure)
}
inline ::service_layer::SLSrv6SidStruct* SLSRv6SIDInfo::release_structure() {
...
inline ::service_layer::SLSrv6SidStruct* SLSRv6SIDInfo::unsafe_arena_release_structure() {
  // @@protoc_insertion_point(field_release:service_layer.SLSRv6SIDInfo.structure)
  
  ::service_layer::SLSrv6SidStruct* temp = structure_;
  structure_ = nullptr;
  return temp;
}
inline ::service_layer::SLSrv6SidStruct* SLSRv6SIDInfo::_internal_mutable_structure() {
...
inline ::service_layer::SLSrv6SidStruct* SLSRv6SIDInfo::mutable_structure() {
  ::service_layer::SLSrv6SidStruct* _msg = _internal_mutable_structure();
  // @@protoc_insertion_point(field_mutable:service_layer.SLSRv6SIDInfo.structure)
  return _msg;
}
inline void SLSRv6SIDInfo::set_allocated_structure(::service_layer::SLSrv6SidStruct* structure) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete structure_;
  }
  ...
  structure_ = structure;
  // @@protoc_insertion_point(field_set_allocated:service_layer.SLSRv6SIDInfo.structure)
}
...
// .service_layer.SLSRv6SIDInfo srv6_sid = 1;
inline bool SLSrteSegment_TypeB::_internal_has_srv6_sid() const {
  return this != internal_default_instance() && srv6_sid_ != nullptr;
}
inline bool SLSrteSegment_TypeB::has_srv6_sid() const {
  return _internal_has_srv6_sid();
}
inline void SLSrteSegment_TypeB::clear_srv6_sid() {
  if (GetArenaForAllocation() == nullptr && srv6_sid_ != nullptr) {
    delete srv6_sid_;
  }
  srv6_sid_ = nullptr;
}
inline const ::service_layer::SLSRv6SIDInfo& SLSrteSegment_TypeB::_internal_srv6_sid() const {
  const ::service_layer::SLSRv6SIDInfo* p = srv6_sid_;
  return p != nullptr ? *p : reinterpret_cast<const ::service_layer::SLSRv6SIDInfo&>(
      ::service_layer::_SLSRv6SIDInfo_default_instance_);
}
inline const ::service_layer::SLSRv6SIDInfo& SLSrteSegment_TypeB::srv6_sid() const {
  // @@protoc_insertion_point(field_get:service_layer.SLSrteSegment.TypeB.srv6_sid)
  return _internal_srv6_sid();
}
inline void SLSrteSegment_TypeB::unsafe_arena_set_allocated_srv6_sid(
    ::service_layer::SLSRv6SIDInfo* srv6_sid) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(srv6_sid_);
  }
  srv6_sid_ = srv6_sid;
  if (srv6_sid) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:service_layer.SLSrteSegment.TypeB.srv6_sid)
}
inline ::service_layer::SLSRv6SIDInfo* SLSrteSegment_TypeB::release_srv6_sid() {
  
  ::service_layer::SLSRv6SIDInfo* temp = srv6_sid_;
  srv6_sid_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::service_layer::SLSRv6SIDInfo* SLSrteSegment_TypeB::unsafe_arena_release_srv6_sid() {
  // @@protoc_insertion_point(field_release:service_layer.SLSrteSegment.TypeB.srv6_sid)
  
  ::service_layer::SLSRv6SIDInfo* temp = srv6_sid_;
  srv6_sid_ = nullptr;
  return temp;
}
inline ::service_layer::SLSRv6SIDInfo* SLSrteSegment_TypeB::_internal_mutable_srv6_sid() {
  
  if (srv6_sid_ == nullptr) {
    auto* p = CreateMaybeMessage<::service_layer::SLSRv6SIDInfo>(GetArenaForAllocation());
    srv6_sid_ = p;
  }
  return srv6_sid_;
}
inline ::service_layer::SLSRv6SIDInfo* SLSrteSegment_TypeB::mutable_srv6_sid() {
  ::service_layer::SLSRv6SIDInfo* _msg = _internal_mutable_srv6_sid();
  // @@protoc_insertion_point(field_mutable:service_layer.SLSrteSegment.TypeB.srv6_sid)
  return _msg;
}
inline void SLSrteSegment_TypeB::set_allocated_srv6_sid(::service_layer::SLSRv6SIDInfo* srv6_sid) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete srv6_sid_;
  }
  if (srv6_sid) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::service_layer::SLSRv6SIDInfo>::GetOwningArena(srv6_sid);
    if (message_arena != submessage_arena) {
      srv6_sid = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, srv6_sid, submessage_arena);
    }
  ...
  srv6_sid_ = srv6_sid;
  // @@protoc_insertion_point(field_set_allocated:service_layer.SLSrteSegment.TypeB.srv6_sid)
}
...
// .service_layer.SLErrorStatus type = 1;
inline bool SLSrStatus::_internal_has_type() const {
  return this != internal_default_instance() && type_ != nullptr;
}
inline bool SLSrStatus::has_type() const {
  return _internal_has_type();
}
inline const ::service_layer::SLErrorStatus& SLSrStatus::_internal_type() const {
...
inline const ::service_layer::SLErrorStatus& SLSrStatus::type() const {
  // @@protoc_insertion_point(field_get:service_layer.SLSrStatus.type)
  return _internal_type();
}
inline void SLSrStatus::unsafe_arena_set_allocated_type(
    ::service_layer::SLErrorStatus* type) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:service_layer.SLSrStatus.type)
}
inline ::service_layer::SLErrorStatus* SLSrStatus::release_type() {
...
inline ::service_layer::SLErrorStatus* SLSrStatus::unsafe_arena_release_type() {
  // @@protoc_insertion_point(field_release:service_layer.SLSrStatus.type)
  
  ::service_layer::SLErrorStatus* temp = type_;
  type_ = nullptr;
  return temp;
}
inline ::service_layer::SLErrorStatus* SLSrStatus::_internal_mutable_type() {
...
inline ::service_layer::SLErrorStatus* SLSrStatus::mutable_type() {
  ::service_layer::SLErrorStatus* _msg = _internal_mutable_type();
  // @@protoc_insertion_point(field_mutable:service_layer.SLSrStatus.type)
  return _msg;
}
inline void SLSrStatus::set_allocated_type(::service_layer::SLErrorStatus* type) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(type_);
  }
  ...
  type_ = type;
  // @@protoc_insertion_point(field_set_allocated:service_layer.SLSrStatus.type)
}

// optional string description = 2;
inline bool SLSrStatus::_internal_has_description() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool SLSrStatus::has_description() const {
  return _internal_has_description();
}
inline void SLSrStatus::clear_description() {
  description_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000001u;
}
inline const std::string& SLSrStatus::description() const {
  // @@protoc_insertion_point(field_get:service_layer.SLSrStatus.description)
  return _internal_description();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SLSrStatus::set_description(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 description_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:service_layer.SLSrStatus.description)
}
inline std::string* SLSrStatus::mutable_description() {
  std::string* _s = _internal_mutable_description();
  // @@protoc_insertion_point(field_mutable:service_layer.SLSrStatus.description)
  return _s;
}
inline const std::string& SLSrStatus::_internal_description() const {
  return description_.Get();
}
inline void SLSrStatus::_internal_set_description(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  description_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* SLSrStatus::_internal_mutable_description() {
  _has_bits_[0] |= 0x00000001u;
  return description_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* SLSrStatus::release_description() {
  // @@protoc_insertion_point(field_release:service_layer.SLSrStatus.description)
...
inline void SLSrStatus::set_allocated_description(std::string* description) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:service_layer.SLSrStatus.description)
}
...
template <> struct is_proto_enum< ::service_layer::SLSrteProtectionType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::service_layer::SLSrteProtectionType>() {
  return ::service_layer::SLSrteProtectionType_descriptor();
}
