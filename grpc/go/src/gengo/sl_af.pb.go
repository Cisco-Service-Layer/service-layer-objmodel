...
func (x *SLRedistMarker) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SLRedistMarker) ProtoMessage() {}

func (x *SLRedistMarker) ProtoReflect() protoreflect.Message {
	mi := &file_sl_af_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SLRedistMarker.ProtoReflect.Descriptor instead.
func (*SLRedistMarker) Descriptor() ([]byte, []int) {
	return file_sl_af_proto_rawDescGZIP(), []int{24}
}

func (x *SLRedistMarker) GetTable() SLTableType {
	if x != nil {
		return x.Table
	}
	return SLTableType_SL_TABLE_TYPE_RESERVED
...
func (x *SLAFNotif) GetStartMarker() *SLRedistMarker {
...
func (x *SLAFNotif) GetEndMarker() *SLRedistMarker {
...
type SLAFNotif_StartMarker struct {
	...
	// database.
	StartMarker *SLRedistMarker `protobuf:"bytes,2,opt,name=StartMarker,proto3,oneof"`
}
...
type SLAFNotif_EndMarker struct {
	...
	EndMarker *SLRedistMarker `protobuf:"bytes,3,opt,name=EndMarker,proto3,oneof"`
}
...
var file_sl_af_proto_rawDesc = []byte{
	...
	0x62, 0x6c, 0x65, 0x22, 0xce, 0x02, 0x0a, 0x09, 0x53, 0x4c, 0x41, 0x46, 0x4e, 0x6f, 0x74, 0x69,
	...
	0x75, 0x73, 0x12, 0x41, 0x0a, 0x0b, 0x53, 0x74, 0x61, 0x72, 0x74, 0x4d, 0x61, 0x72, 0x6b, 0x65,
	0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x5f, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x2e, 0x53, 0x4c, 0x52, 0x65, 0x64, 0x69, 0x73, 0x74,
	0x4d, 0x61, 0x72, 0x6b, 0x65, 0x72, 0x48, 0x00, 0x52, 0x0b, 0x53, 0x74, 0x61, 0x72, 0x74, 0x4d,
	0x61, 0x72, 0x6b, 0x65, 0x72, 0x12, 0x3d, 0x0a, 0x09, 0x45, 0x6e, 0x64, 0x4d, 0x61, 0x72, 0x6b,
	0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x5f, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x2e, 0x53, 0x4c, 0x52, 0x65, 0x64, 0x69, 0x73,
	...
	0x48, 0x00, 0x52, 0x07, 0x4e, 0x65, 0x78, 0x74, 0x48, 0x6f, 0x70, 0x42, 0x07, 0x0a, 0x05, 0x45,
...
var file_sl_af_proto_goTypes = []interface{}{
	...
	(*SLRedistMarker)(nil),                 // 24: service_layer.SLRedistMarker
...
var file_sl_af_proto_depIdxs = []int32{
	...
	29, // 36: service_layer.SLAFNextHopRegKey.NextHop:type_name -> service_layer.SLAFNextHopRegKey.SLNextHopKey
	...
	30, // 47: service_layer.SLRedistMarker.Table:type_name -> service_layer.SLTableType
	22, // 48: service_layer.SLAFNotif.NotifStatus:type_name -> service_layer.SLAFNotifRsp
	24, // 49: service_layer.SLAFNotif.StartMarker:type_name -> service_layer.SLRedistMarker
	24, // 50: service_layer.SLAFNotif.EndMarker:type_name -> service_layer.SLRedistMarker
	8,  // 51: service_layer.SLAFNotif.RedistObject:type_name -> service_layer.SLAFObject
	23, // 52: service_layer.SLAFNotif.NextHop:type_name -> service_layer.SLNextHop
	25, // 53: service_layer.SLAFNotifMsg.AFNotifs:type_name -> service_layer.SLAFNotif
	35, // 54: service_layer.SLPathGroup.SLPath.Path:type_name -> service_layer.SLRoutePath
	27, // 55: service_layer.SLPathGroup.SLPathList.Paths:type_name -> service_layer.SLPathGroup.SLPath
	43, // 56: service_layer.SLAFNextHopRegKey.SLNextHopKey.NextHop:type_name -> service_layer.SLIpAddress
	...
	26, // 68: service_layer.SLAF.SLAFNotifStream:output_type -> service_layer.SLAFNotifMsg
