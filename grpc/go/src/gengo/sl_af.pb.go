...
func (x *SLAFEntry) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SLAFEntry) ProtoMessage() {}

func (x *SLAFEntry) ProtoReflect() protoreflect.Message {
	mi := &file_sl_af_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SLAFEntry.ProtoReflect.Descriptor instead.
func (*SLAFEntry) Descriptor() ([]byte, []int) {
	return file_sl_af_proto_rawDescGZIP(), []int{11}
}

func (x *SLAFEntry) GetAFOp() *SLAFOp {
	if x != nil {
		return x.AFOp
	}
	return nil
...
type SLAFGetMsgRsp struct {
	...
	AFList []*SLAFEntry `protobuf:"bytes,4,rep,name=AFList,proto3" json:"AFList,omitempty"`
}
...
func (x *SLAFGetMsgRsp) GetAFList() []*SLAFEntry {
	if x != nil {
		return x.AFList
	}
	return nil
...
var file_sl_af_proto_rawDesc = []byte{
	...
	0x52, 0x0a, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x67, 0x65, 0x78, 0x22, 0x36, 0x0a, 0x09,
	0x53, 0x4c, 0x41, 0x46, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x29, 0x0a, 0x04, 0x41, 0x46, 0x4f,
	...
	0x41, 0x46, 0x4f, 0x70, 0x22, 0xb3, 0x01, 0x0a, 0x0d, 0x53, 0x4c, 0x41, 0x46, 0x47, 0x65, 0x74,
	...
	0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x49, 0x44, 0x12, 0x30, 0x0a, 0x06, 0x41, 0x46, 0x4c, 0x69,
	0x73, 0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x5f, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x2e, 0x53, 0x4c, 0x41, 0x46, 0x45, 0x6e, 0x74,
	...
	0x53, 0x4c, 0x41, 0x46, 0x4f, 0x70, 0x52, 0x06, 0x4f, 0x70, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x7a,
	...
	0x09, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x58, 0x0a, 0x0a, 0x53, 0x4c,
	...
	0x70, 0x65, 0x52, 0x05, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x22, 0x7f, 0x0a, 0x0f, 0x53, 0x4c, 0x41,
	0x46, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x52, 0x65, 0x67, 0x52, 0x65, 0x71, 0x12, 0x3f, 0x0a, 0x09,
	0x52, 0x65, 0x64, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x48, 0x00, 0x52, 0x09, 0x52, 0x65, 0x64, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x12, 0x20, 0x0a,
	...
	0x0b, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x96, 0x01, 0x0a,
	...
	0x4e, 0x6f, 0x74, 0x69, 0x66, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x3f, 0x0a, 0x0c, 0x52,
	...
	0x52, 0x65, 0x64, 0x69, 0x73, 0x74, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x42, 0x07, 0x0a, 0x05,
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x22, 0x90, 0x01, 0x0a, 0x0c, 0x53, 0x4c, 0x41, 0x46, 0x4e, 0x6f,
	0x74, 0x69, 0x66, 0x4d, 0x73, 0x67, 0x12, 0x18, 0x0a, 0x07, 0x56, 0x72, 0x66, 0x4e, 0x61, 0x6d,
	...
	0x6c, 0x65, 0x12, 0x34, 0x0a, 0x08, 0x41, 0x46, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x73, 0x18, 0x03,
...
var file_sl_af_proto_goTypes = []interface{}{
	...
	(*SLAFEntry)(nil),              // 11: service_layer.SLAFEntry
...
var file_sl_af_proto_depIdxs = []int32{
	...
	9,  // 22: service_layer.SLAFEntry.AFOp:type_name -> service_layer.SLAFOp
	27, // 23: service_layer.SLAFGetMsgRsp.ErrStatus:type_name -> service_layer.SLErrorStatus
	11, // 24: service_layer.SLAFGetMsgRsp.AFList:type_name -> service_layer.SLAFEntry
	34, // 25: service_layer.SLAFMsg.Oper:type_name -> service_layer.SLObjectOp
	9,  // 26: service_layer.SLAFMsg.OpList:type_name -> service_layer.SLAFOp
	27, // 27: service_layer.SLAFRes.ErrStatus:type_name -> service_layer.SLErrorStatus
	9,  // 28: service_layer.SLAFRes.Operation:type_name -> service_layer.SLAFOp
	14, // 29: service_layer.SLAFMsgRsp.Results:type_name -> service_layer.SLAFRes
	24, // 30: service_layer.SLAFRedistRegMsg.Table:type_name -> service_layer.SLTableType
	16, // 31: service_layer.SLAFNotifRegReq.RedistReq:type_name -> service_layer.SLAFRedistRegMsg
	35, // 32: service_layer.SLAFNotifReq.Oper:type_name -> service_layer.SLNotifOp
	17, // 33: service_layer.SLAFNotifReq.NotifReq:type_name -> service_layer.SLAFNotifRegReq
	17, // 34: service_layer.SLAFNotifRsp.NotifReq:type_name -> service_layer.SLAFNotifRegReq
	27, // 35: service_layer.SLAFNotifRsp.NotifStatus:type_name -> service_layer.SLErrorStatus
	19, // 36: service_layer.SLAFNotif.NotifStatus:type_name -> service_layer.SLAFNotifRsp
	8,  // 37: service_layer.SLAFNotif.RedistObject:type_name -> service_layer.SLAFObject
	24, // 38: service_layer.SLAFNotifMsg.Table:type_name -> service_layer.SLTableType
	20, // 39: service_layer.SLAFNotifMsg.AFNotifs:type_name -> service_layer.SLAFNotif
	29, // 40: service_layer.SLPathGroup.SLPath.Path:type_name -> service_layer.SLRoutePath
	22, // 41: service_layer.SLPathGroup.SLPathList.Paths:type_name -> service_layer.SLPathGroup.SLPath
	1,  // 42: service_layer.SLAF.SLAFVrfRegOp:input_type -> service_layer.SLAFVrfRegMsg
	4,  // 43: service_layer.SLAF.SLAFVrfRegGet:input_type -> service_layer.SLAFVrfRegGetMsg
	13, // 44: service_layer.SLAF.SLAFOp:input_type -> service_layer.SLAFMsg
	13, // 45: service_layer.SLAF.SLAFOpStream:input_type -> service_layer.SLAFMsg
	10, // 46: service_layer.SLAF.SLAFGet:input_type -> service_layer.SLAFGetMsg
	18, // 47: service_layer.SLAF.SLAFNotifStream:input_type -> service_layer.SLAFNotifReq
	3,  // 48: service_layer.SLAF.SLAFVrfRegOp:output_type -> service_layer.SLAFVrfRegMsgRsp
	5,  // 49: service_layer.SLAF.SLAFVrfRegGet:output_type -> service_layer.SLAFVrfRegGetMsgRsp
	15, // 50: service_layer.SLAF.SLAFOp:output_type -> service_layer.SLAFMsgRsp
	15, // 51: service_layer.SLAF.SLAFOpStream:output_type -> service_layer.SLAFMsgRsp
	12, // 52: service_layer.SLAF.SLAFGet:output_type -> service_layer.SLAFGetMsgRsp
	21, // 53: service_layer.SLAF.SLAFNotifStream:output_type -> service_layer.SLAFNotifMsg
