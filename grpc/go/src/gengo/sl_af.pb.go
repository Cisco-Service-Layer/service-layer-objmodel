...
func (x *SLAFGetMsgRspEntry) GetFIBStatus() *SLErrorStatus {
	if x != nil {
		return x.FIBStatus
	}
	return nil
...
func (x *SLAFGetMsgRspEntry) GetFIBVersion() uint64 {
	if x != nil {
		return x.FIBVersion
	}
	return 0
...
type SLAFRes struct {
	...
	AFOp *SLAFOp `protobuf:"bytes,3,opt,name=AFOp,proto3" json:"AFOp,omitempty"`
	// Error code associated with the hardware programming of operation.
	FIBStatus *SLErrorStatus `protobuf:"bytes,4,opt,name=FIBStatus,proto3" json:"FIBStatus,omitempty"`
	// if ACK type requested was RIB_AND_FIB_ACK, then FIBVersion indicates
	// the latest version associated with the hardware programming of operation.
	// FIBVersion if present is a non-zero positive number.
	FIBVersion uint64 `protobuf:"varint,5,opt,name=FIBVersion,proto3" json:"FIBVersion,omitempty"`
	// Descriptive string describing error if any, on the operation.
	ErrorString string `protobuf:"bytes,6,opt,name=ErrorString,proto3" json:"ErrorString,omitempty"`
	...
	DepResult []*SLAFRes `protobuf:"bytes,7,rep,name=DepResult,proto3" json:"DepResult,omitempty"`
}
...
func (x *SLAFRes) GetFIBStatus() *SLErrorStatus {
	if x != nil {
		return x.FIBStatus
	}
	return nil
...
func (x *SLAFRes) GetFIBVersion() uint64 {
	if x != nil {
		return x.FIBVersion
	}
	return 0
...
func (x *SLAFRes) GetDepResult() []*SLAFRes {
	if x != nil {
		return x.DepResult
	}
	return nil
...
var file_sl_af_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x52, 0x07, 0x41, 0x63, 0x6b, 0x54, 0x79, 0x70, 0x65, 0x22, 0x9e, 0x01, 0x0a, 0x0a,
	...
	0x65, 0x74, 0x41, 0x6c, 0x6c, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x1e, 0x0a, 0x0a,
	0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x67, 0x65, 0x78, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0a, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x67, 0x65, 0x78, 0x22, 0x9b, 0x01, 0x0a,
	...
	0x0a, 0x09, 0x46, 0x49, 0x42, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x09, 0x46, 0x49, 0x42, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1e, 0x0a, 0x0a, 0x46, 0x49,
	0x42, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a,
	0x46, 0x49, 0x42, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xbc, 0x01, 0x0a, 0x0d, 0x53,
	...
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x2e, 0x53,
	0x4c, 0x41, 0x46, 0x4f, 0x70, 0x52, 0x06, 0x4f, 0x70, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xc6, 0x02,
	...
	,
	...
	0x54, 0x61, 0x62, 0x6c, 0x65, 0x22, 0x7f, 0x0a, 0x0f, 0x53, 0x4c, 0x41, 0x46, 0x4e, 0x6f, 0x74,
	...
	0x52, 0x65, 0x64, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x12, 0x20, 0x0a, 0x0b, 0x4f, 0x70, 0x65,
	...
	0x69, 0x66, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x96, 0x01, 0x0a, 0x09, 0x53, 0x4c, 0x41,
	...
	0x66, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x3f, 0x0a, 0x0c, 0x52, 0x65, 0x64, 0x69, 0x73,
	0x74, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x2e, 0x53, 0x4c,
	0x41, 0x46, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x48, 0x00, 0x52, 0x0c, 0x52, 0x65, 0x64, 0x69,
	0x73, 0x74, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x42, 0x07, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e,
	0x74, 0x22, 0x90, 0x01, 0x0a, 0x0c, 0x53, 0x4c, 0x41, 0x46, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x4d,
	...
	0x62, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x05, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x34,
...
var file_sl_af_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_sl_af_proto_goTypes = []interface{}{
	...
	(*SLAFGetMsgRspEntry)(nil),     // 11: service_layer.SLAFGetMsgRspEntry
	(*SLAFGetMsgRsp)(nil),          // 12: service_layer.SLAFGetMsgRsp
	(*SLAFMsg)(nil),                // 13: service_layer.SLAFMsg
	(*SLAFRes)(nil),                // 14: service_layer.SLAFRes
	(*SLAFMsgRsp)(nil),             // 15: service_layer.SLAFMsgRsp
	(*SLAFRedistRegMsg)(nil),       // 16: service_layer.SLAFRedistRegMsg
	(*SLAFNotifRegReq)(nil),        // 17: service_layer.SLAFNotifRegReq
	(*SLAFNotifReq)(nil),           // 18: service_layer.SLAFNotifReq
	(*SLAFNotifRsp)(nil),           // 19: service_layer.SLAFNotifRsp
	(*SLAFNotif)(nil),              // 20: service_layer.SLAFNotif
	(*SLAFNotifMsg)(nil),           // 21: service_layer.SLAFNotifMsg
	(*SLPathGroup_SLPath)(nil),     // 22: service_layer.SLPathGroup.SLPath
	(*SLPathGroup_SLPathList)(nil), // 23: service_layer.SLPathGroup.SLPathList
	(SLTableType)(0),               // 24: service_layer.SLTableType
	(*SLVrfReg)(nil),               // 25: service_layer.SLVrfReg
	(SLRegOp)(0),                   // 26: service_layer.SLRegOp
	(*SLErrorStatus)(nil),          // 27: service_layer.SLErrorStatus
	(*SLObjectId)(nil),             // 28: service_layer.SLObjectId
	(*SLRoutePath)(nil),            // 29: service_layer.SLRoutePath
	(*SLPathGroupRefKey)(nil),      // 30: service_layer.SLPathGroupRefKey
	(*SLRoutev4)(nil),              // 31: service_layer.SLRoutev4
	(*SLRoutev6)(nil),              // 32: service_layer.SLRoutev6
	(SLRspACKType)(0),              // 33: service_layer.SLRspACKType
	(SLObjectOp)(0),                // 34: service_layer.SLObjectOp
	(SLNotifOp)(0),                 // 35: service_layer.SLNotifOp
}
var file_sl_af_proto_depIdxs = []int32{
	24, // 0: service_layer.SLAFVrfReg.Table:type_name -> service_layer.SLTableType
	25, // 1: service_layer.SLAFVrfReg.VrfReg:type_name -> service_layer.SLVrfReg
	26, // 2: service_layer.SLAFVrfRegMsg.Oper:type_name -> service_layer.SLRegOp
	0,  // 3: service_layer.SLAFVrfRegMsg.VrfRegMsgs:type_name -> service_layer.SLAFVrfReg
	27, // 4: service_layer.SLAFVrfRegMsgRes.ErrStatus:type_name -> service_layer.SLErrorStatus
	24, // 5: service_layer.SLAFVrfRegMsgRes.Table:type_name -> service_layer.SLTableType
	27, // 6: service_layer.SLAFVrfRegMsgRsp.StatusSummary:type_name -> service_layer.SLErrorStatus
	2,  // 7: service_layer.SLAFVrfRegMsgRsp.Results:type_name -> service_layer.SLAFVrfRegMsgRes
	27, // 8: service_layer.SLAFVrfRegGetMsgRsp.ErrStatus:type_name -> service_layer.SLErrorStatus
	24, // 9: service_layer.SLAFVrfRegGetMsgRsp.Table:type_name -> service_layer.SLTableType
	25, // 10: service_layer.SLAFVrfRegGetMsgRsp.Entries:type_name -> service_layer.SLVrfReg
	28, // 11: service_layer.SLPathGroup.PathGroupId:type_name -> service_layer.SLObjectId
	23, // 12: service_layer.SLPathGroup.PathList:type_name -> service_layer.SLPathGroup.SLPathList
	29, // 13: service_layer.SLMplsEntry.PathList:type_name -> service_layer.SLRoutePath
	30, // 14: service_layer.SLMplsEntry.PathGroupKey:type_name -> service_layer.SLPathGroupRefKey
	31, // 15: service_layer.SLAFObject.IPv4Route:type_name -> service_layer.SLRoutev4
	32, // 16: service_layer.SLAFObject.IPv6Route:type_name -> service_layer.SLRoutev6
	...
	33, // 20: service_layer.SLAFOp.AckType:type_name -> service_layer.SLRspACKType
	24, // 21: service_layer.SLAFGetMsg.Table:type_name -> service_layer.SLTableType
	9,  // 22: service_layer.SLAFGetMsgRspEntry.AFOp:type_name -> service_layer.SLAFOp
	27, // 23: service_layer.SLAFGetMsgRspEntry.FIBStatus:type_name -> service_layer.SLErrorStatus
	27, // 24: service_layer.SLAFGetMsgRsp.ErrStatus:type_name -> service_layer.SLErrorStatus
	11, // 25: service_layer.SLAFGetMsgRsp.AFList:type_name -> service_layer.SLAFGetMsgRspEntry
	34, // 26: service_layer.SLAFMsg.Oper:type_name -> service_layer.SLObjectOp
	9,  // 27: service_layer.SLAFMsg.OpList:type_name -> service_layer.SLAFOp
	27, // 28: service_layer.SLAFRes.ErrStatus:type_name -> service_layer.SLErrorStatus
	9,  // 29: service_layer.SLAFRes.AFOp:type_name -> service_layer.SLAFOp
	27, // 30: service_layer.SLAFRes.FIBStatus:type_name -> service_layer.SLErrorStatus
	14, // 31: service_layer.SLAFRes.DepResult:type_name -> service_layer.SLAFRes
	14, // 32: service_layer.SLAFMsgRsp.Results:type_name -> service_layer.SLAFRes
	24, // 33: service_layer.SLAFRedistRegMsg.Table:type_name -> service_layer.SLTableType
	16, // 34: service_layer.SLAFNotifRegReq.RedistReq:type_name -> service_layer.SLAFRedistRegMsg
	35, // 35: service_layer.SLAFNotifReq.Oper:type_name -> service_layer.SLNotifOp
	17, // 36: service_layer.SLAFNotifReq.NotifReq:type_name -> service_layer.SLAFNotifRegReq
	17, // 37: service_layer.SLAFNotifRsp.NotifReq:type_name -> service_layer.SLAFNotifRegReq
	27, // 38: service_layer.SLAFNotifRsp.NotifStatus:type_name -> service_layer.SLErrorStatus
	19, // 39: service_layer.SLAFNotif.NotifStatus:type_name -> service_layer.SLAFNotifRsp
	8,  // 40: service_layer.SLAFNotif.RedistObject:type_name -> service_layer.SLAFObject
	24, // 41: service_layer.SLAFNotifMsg.Table:type_name -> service_layer.SLTableType
	20, // 42: service_layer.SLAFNotifMsg.AFNotifs:type_name -> service_layer.SLAFNotif
	29, // 43: service_layer.SLPathGroup.SLPath.Path:type_name -> service_layer.SLRoutePath
	22, // 44: service_layer.SLPathGroup.SLPathList.Paths:type_name -> service_layer.SLPathGroup.SLPath
	1,  // 45: service_layer.SLAF.SLAFVrfRegOp:input_type -> service_layer.SLAFVrfRegMsg
	4,  // 46: service_layer.SLAF.SLAFVrfRegGet:input_type -> service_layer.SLAFVrfRegGetMsg
	13, // 47: service_layer.SLAF.SLAFOp:input_type -> service_layer.SLAFMsg
	13, // 48: service_layer.SLAF.SLAFOpStream:input_type -> service_layer.SLAFMsg
	10, // 49: service_layer.SLAF.SLAFGet:input_type -> service_layer.SLAFGetMsg
	18, // 50: service_layer.SLAF.SLAFNotifStream:input_type -> service_layer.SLAFNotifReq
	3,  // 51: service_layer.SLAF.SLAFVrfRegOp:output_type -> service_layer.SLAFVrfRegMsgRsp
	5,  // 52: service_layer.SLAF.SLAFVrfRegGet:output_type -> service_layer.SLAFVrfRegGetMsgRsp
	15, // 53: service_layer.SLAF.SLAFOp:output_type -> service_layer.SLAFMsgRsp
	15, // 54: service_layer.SLAF.SLAFOpStream:output_type -> service_layer.SLAFMsgRsp
	12, // 55: service_layer.SLAF.SLAFGet:output_type -> service_layer.SLAFGetMsgRsp
	21, // 56: service_layer.SLAF.SLAFNotifStream:output_type -> service_layer.SLAFNotifMsg
