...
func (SLGlobalNotifType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_sl_global_ba58fa31ce6e93d9, []int{0}
}
...
func (*SLInitMsgRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_sl_global_ba58fa31ce6e93d9, []int{1}
}
...
func (*SLVrfRouteReplayErrorNotif) Descriptor() ([]byte, []int) {
	return fileDescriptor_sl_global_ba58fa31ce6e93d9, []int{2}
}
func (m *SLVrfRouteReplayErrorNotif) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_SLVrfRouteReplayErrorNotif.Unmarshal(m, b)
}
func (m *SLVrfRouteReplayErrorNotif) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_SLVrfRouteReplayErrorNotif.Marshal(b, m, deterministic)
}
func (dst *SLVrfRouteReplayErrorNotif) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SLVrfRouteReplayErrorNotif.Merge(dst, src)
}
func (m *SLVrfRouteReplayErrorNotif) XXX_Size() int {
	return xxx_messageInfo_SLVrfRouteReplayErrorNotif.Size(m)
}
func (m *SLVrfRouteReplayErrorNotif) XXX_DiscardUnknown() {
	xxx_messageInfo_SLVrfRouteReplayErrorNotif.DiscardUnknown(m)
}

var xxx_messageInfo_SLVrfRouteReplayErrorNotif proto.InternalMessageInfo
...
func (*SLGlobalNotif) Descriptor() ([]byte, []int) {
	return fileDescriptor_sl_global_ba58fa31ce6e93d9, []int{3}
}
...
func (*SLGlobalsGetMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_sl_global_ba58fa31ce6e93d9, []int{4}
}
...
func (*SLGlobalsGetMsgRsp) Descriptor() ([]byte, []int) {
	return fileDescriptor_sl_global_ba58fa31ce6e93d9, []int{5}
}
...
func init() { proto.RegisterFile("sl_global.proto", fileDescriptor_sl_global_ba58fa31ce6e93d9) }

var fileDescriptor_sl_global_ba58fa31ce6e93d9 = []byte{
