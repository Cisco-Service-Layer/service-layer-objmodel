...
const (
	...
	SlLabelAction_SL_LABEL_ACTION_PUSH SlLabelAction = 6
)
...
type SLMplsIlmEntry_UpdatePriority int32

const (
	// Reserved. 0x0
	SLMplsIlmEntry_RESERVED SLMplsIlmEntry_UpdatePriority = 0
	SLMplsIlmEntry_CRITICAL SLMplsIlmEntry_UpdatePriority = 1
	SLMplsIlmEntry_HIGH     SLMplsIlmEntry_UpdatePriority = 2
	SLMplsIlmEntry_MEDIUM   SLMplsIlmEntry_UpdatePriority = 3
	SLMplsIlmEntry_LOW      SLMplsIlmEntry_UpdatePriority = 4
)

// Enum value maps for SLMplsIlmEntry_UpdatePriority.
var (
	SLMplsIlmEntry_UpdatePriority_name = map[int32]string{
		0: "RESERVED",
		1: "CRITICAL",
		2: "HIGH",
		3: "MEDIUM",
	...
	SLMplsIlmEntry_UpdatePriority_value = map[string]int32{
		"RESERVED": 0,
		"CRITICAL": 1,
		"HIGH":     2,
		"MEDIUM":   3,
...
func (x SLMplsIlmEntry_UpdatePriority) Enum() *SLMplsIlmEntry_UpdatePriority {
	p := new(SLMplsIlmEntry_UpdatePriority)
	*p = x
	return p
}

func (x SLMplsIlmEntry_UpdatePriority) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SLMplsIlmEntry_UpdatePriority) Descriptor() protoreflect.EnumDescriptor {
	return file_sl_mpls_proto_enumTypes[2].Descriptor()
}

func (SLMplsIlmEntry_UpdatePriority) Type() protoreflect.EnumType {
	return &file_sl_mpls_proto_enumTypes[2]
}

func (x SLMplsIlmEntry_UpdatePriority) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SLMplsIlmEntry_UpdatePriority.Descriptor instead.
func (SLMplsIlmEntry_UpdatePriority) EnumDescriptor() ([]byte, []int) {
	return file_sl_mpls_proto_rawDescGZIP(), []int{15, 0}
}
...
func (x *SLMplsIlmKey) GetPrefix() *SLMplsIlmKey_IPPrefixKey {
	if x != nil {
		return x.Prefix
	}
	return nil
...
type SLMplsIlmEntry struct {
	...
	// Priority.
	// Each entry can have priority value, this is priority value may be used
	// in internal queuing of routes while programming the data-plane
	Priority SLMplsIlmEntry_UpdatePriority `protobuf:"varint,3,opt,name=Priority,proto3,enum=service_layer.SLMplsIlmEntry_UpdatePriority" json:"Priority,omitempty"`
}
...
func (x *SLMplsIlmEntry) GetPriority() SLMplsIlmEntry_UpdatePriority {
	if x != nil {
		return x.Priority
	}
	return SLMplsIlmEntry_RESERVED
}
...
type SLMplsIlmKey_IPv4PrefixKey struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SLMplsIlmKey_IPv4PrefixKey) Reset() {
	*x = SLMplsIlmKey_IPv4PrefixKey{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sl_mpls_proto_msgTypes[21]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SLMplsIlmKey_IPv4PrefixKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SLMplsIlmKey_IPv4PrefixKey) ProtoMessage() {}

func (x *SLMplsIlmKey_IPv4PrefixKey) ProtoReflect() protoreflect.Message {
	mi := &file_sl_mpls_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SLMplsIlmKey_IPv4PrefixKey.ProtoReflect.Descriptor instead.
func (*SLMplsIlmKey_IPv4PrefixKey) Descriptor() ([]byte, []int) {
	return file_sl_mpls_proto_rawDescGZIP(), []int{13, 0}
}

func (x *SLMplsIlmKey_IPv4PrefixKey) GetPrefix() uint32 {
	if x != nil {
		return x.Prefix
	}
	return 0
...
type SLMplsIlmKey_IPv6PrefixKey struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SLMplsIlmKey_IPv6PrefixKey) Reset() {
	*x = SLMplsIlmKey_IPv6PrefixKey{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sl_mpls_proto_msgTypes[22]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SLMplsIlmKey_IPv6PrefixKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SLMplsIlmKey_IPv6PrefixKey) ProtoMessage() {}

func (x *SLMplsIlmKey_IPv6PrefixKey) ProtoReflect() protoreflect.Message {
	mi := &file_sl_mpls_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SLMplsIlmKey_IPv6PrefixKey.ProtoReflect.Descriptor instead.
func (*SLMplsIlmKey_IPv6PrefixKey) Descriptor() ([]byte, []int) {
	return file_sl_mpls_proto_rawDescGZIP(), []int{13, 1}
}

func (x *SLMplsIlmKey_IPv6PrefixKey) GetPrefix() []byte {
	if x != nil {
		return x.Prefix
	}
	return nil
...
type SLMplsIlmKey_IPPrefixKey struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to Entry:
	//	*SLMplsIlmKey_IPPrefixKey_V4Prefix
	//	*SLMplsIlmKey_IPPrefixKey_V6Prefix
	Entry isSLMplsIlmKey_IPPrefixKey_Entry `protobuf_oneof:"entry"`
...
func (x *SLMplsIlmKey_IPPrefixKey) Reset() {
	*x = SLMplsIlmKey_IPPrefixKey{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sl_mpls_proto_msgTypes[23]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SLMplsIlmKey_IPPrefixKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SLMplsIlmKey_IPPrefixKey) ProtoMessage() {}

func (x *SLMplsIlmKey_IPPrefixKey) ProtoReflect() protoreflect.Message {
	mi := &file_sl_mpls_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SLMplsIlmKey_IPPrefixKey.ProtoReflect.Descriptor instead.
func (*SLMplsIlmKey_IPPrefixKey) Descriptor() ([]byte, []int) {
	return file_sl_mpls_proto_rawDescGZIP(), []int{13, 2}
}

func (m *SLMplsIlmKey_IPPrefixKey) GetEntry() isSLMplsIlmKey_IPPrefixKey_Entry {
	if m != nil {
		return m.Entry
	}
	return nil
...
func (x *SLMplsIlmKey_IPPrefixKey) GetV4Prefix() *SLMplsIlmKey_IPv4PrefixKey {
	if x, ok := x.GetEntry().(*SLMplsIlmKey_IPPrefixKey_V4Prefix); ok {
		return x.V4Prefix
	}
	return nil
}

func (x *SLMplsIlmKey_IPPrefixKey) GetV6Prefix() *SLMplsIlmKey_IPv6PrefixKey {
	if x, ok := x.GetEntry().(*SLMplsIlmKey_IPPrefixKey_V6Prefix); ok {
		return x.V6Prefix
	}
	return nil
}

func (x *SLMplsIlmKey_IPPrefixKey) GetPrefixLen() uint32 {
	if x != nil {
		return x.PrefixLen
	}
	return 0
...
func (x *SLMplsIlmKey_IPPrefixKey) GetVrfName() string {
	if x != nil {
		return x.VrfName
	}
	return ""
...
type isSLMplsIlmKey_IPPrefixKey_Entry interface {
	isSLMplsIlmKey_IPPrefixKey_Entry()
}

type SLMplsIlmKey_IPPrefixKey_V4Prefix struct {
	V4Prefix *SLMplsIlmKey_IPv4PrefixKey `protobuf:"bytes,1,opt,name=V4Prefix,proto3,oneof"`
}

type SLMplsIlmKey_IPPrefixKey_V6Prefix struct {
	V6Prefix *SLMplsIlmKey_IPv6PrefixKey `protobuf:"bytes,2,opt,name=V6Prefix,proto3,oneof"`
}

func (*SLMplsIlmKey_IPPrefixKey_V4Prefix) isSLMplsIlmKey_IPPrefixKey_Entry() {}

func (*SLMplsIlmKey_IPPrefixKey_V6Prefix) isSLMplsIlmKey_IPPrefixKey_Entry() {}
...
var file_sl_mpls_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	0x47, 0x65, 0x74, 0x4e, 0x65, 0x78, 0x74, 0x22, 0xbb, 0x01, 0x0a, 0x12, 0x53, 0x4c, 0x4d, 0x70,
	0x6c, 0x73, 0x49, 0x6c, 0x6d, 0x47, 0x65, 0x74, 0x4d, 0x73, 0x67, 0x52, 0x73, 0x70, 0x12, 0x1e,
	0x0a, 0x0a, 0x43, 0x6f, 0x72, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x0a, 0x43, 0x6f, 0x72, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x10,
	0x0a, 0x03, 0x45, 0x6f, 0x66, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x03, 0x45, 0x6f, 0x66,
	0x12, 0x3a, 0x0a, 0x09, 0x45, 0x72, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x03, 0x20,
	...
	,
	...
	0x5f, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x2e, 0x53, 0x4c, 0x4d, 0x70, 0x6c, 0x73, 0x49, 0x6c, 0x6d,
	0x47, 0x65, 0x74, 0x4d, 0x73, 0x67, 0x52, 0x73, 0x70, 0x28, 0x01, 0x30, 0x01, 0x62, 0x06, 0x70,
...
var file_sl_mpls_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_sl_mpls_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_sl_mpls_proto_goTypes = []interface{}{
	...
	(SLMplsIlmEntry_UpdatePriority)(0), // 2: service_layer.SLMplsIlmEntry.UpdatePriority
	(*SLMplsLabelBlockKey)(nil),        // 3: service_layer.SLMplsLabelBlockKey
	(*SLMplsLabelBlockMsg)(nil),        // 4: service_layer.SLMplsLabelBlockMsg
	(*SLMplsLabelBlockMsgRes)(nil),     // 5: service_layer.SLMplsLabelBlockMsgRes
	(*SLMplsLabelBlockMsgRsp)(nil),     // 6: service_layer.SLMplsLabelBlockMsgRsp
	(*SLMplsLabelBlockGetMsg)(nil),     // 7: service_layer.SLMplsLabelBlockGetMsg
	(*SLMplsLabelBlockGetMsgRsp)(nil),  // 8: service_layer.SLMplsLabelBlockGetMsgRsp
	(*SlMplsReg)(nil),                  // 9: service_layer.SlMplsReg
	(*SLMplsRegMsg)(nil),               // 10: service_layer.SLMplsRegMsg
	(*SLMplsRegMsgRsp)(nil),            // 11: service_layer.SLMplsRegMsgRsp
	(*SLMplsGetMsg)(nil),               // 12: service_layer.SLMplsGetMsg
	(*SLMplsGetMsgRsp)(nil),            // 13: service_layer.SLMplsGetMsgRsp
	(*SLMplsGetStatsMsgRsp)(nil),       // 14: service_layer.SLMplsGetStatsMsgRsp
	(*SLMplsPath)(nil),                 // 15: service_layer.SLMplsPath
	(*SLMplsIlmKey)(nil),               // 16: service_layer.SLMplsIlmKey
	(*SLMplsCos)(nil),                  // 17: service_layer.SLMplsCos
	(*SLMplsIlmEntry)(nil),             // 18: service_layer.SLMplsIlmEntry
	(*SLMplsIlmMsg)(nil),               // 19: service_layer.SLMplsIlmMsg
	(*SLMplsIlmRes)(nil),               // 20: service_layer.SLMplsIlmRes
	(*SLMplsIlmMsgRsp)(nil),            // 21: service_layer.SLMplsIlmMsgRsp
	(*SLMplsIlmGetMsg)(nil),            // 22: service_layer.SLMplsIlmGetMsg
	(*SLMplsIlmGetMsgRsp)(nil),         // 23: service_layer.SLMplsIlmGetMsgRsp
	(*SLMplsIlmKey_IPv4PrefixKey)(nil), // 24: service_layer.SLMplsIlmKey.IPv4PrefixKey
	(*SLMplsIlmKey_IPv6PrefixKey)(nil), // 25: service_layer.SLMplsIlmKey.IPv6PrefixKey
	(*SLMplsIlmKey_IPPrefixKey)(nil),   // 26: service_layer.SLMplsIlmKey.IPPrefixKey
	(SLObjectOp)(0),                    // 27: service_layer.SLObjectOp
	(*SLErrorStatus)(nil),              // 28: service_layer.SLErrorStatus
	(SLRegOp)(0),                       // 29: service_layer.SLRegOp
	(*SLIpAddress)(nil),                // 30: service_layer.SLIpAddress
...
var file_sl_mpls_proto_depIdxs = []int32{
	...
	27, // 1: service_layer.SLMplsLabelBlockMsg.Oper:type_name -> service_layer.SLObjectOp
	3,  // 2: service_layer.SLMplsLabelBlockMsg.MplsBlocks:type_name -> service_layer.SLMplsLabelBlockKey
	28, // 3: service_layer.SLMplsLabelBlockMsgRes.ErrStatus:type_name -> service_layer.SLErrorStatus
	3,  // 4: service_layer.SLMplsLabelBlockMsgRes.Key:type_name -> service_layer.SLMplsLabelBlockKey
	28, // 5: service_layer.SLMplsLabelBlockMsgRsp.StatusSummary:type_name -> service_layer.SLErrorStatus
	5,  // 6: service_layer.SLMplsLabelBlockMsgRsp.Results:type_name -> service_layer.SLMplsLabelBlockMsgRes
	3,  // 7: service_layer.SLMplsLabelBlockGetMsg.Key:type_name -> service_layer.SLMplsLabelBlockKey
	28, // 8: service_layer.SLMplsLabelBlockGetMsgRsp.ErrStatus:type_name -> service_layer.SLErrorStatus
	3,  // 9: service_layer.SLMplsLabelBlockGetMsgRsp.Entries:type_name -> service_layer.SLMplsLabelBlockKey
	29, // 10: service_layer.SLMplsRegMsg.Oper:type_name -> service_layer.SLRegOp
	9,  // 11: service_layer.SLMplsRegMsg.RegMsg:type_name -> service_layer.SlMplsReg
	28, // 12: service_layer.SLMplsRegMsgRsp.ErrStatus:type_name -> service_layer.SLErrorStatus
	28, // 13: service_layer.SLMplsGetMsgRsp.ErrStatus:type_name -> service_layer.SLErrorStatus
	28, // 14: service_layer.SLMplsGetStatsMsgRsp.ErrStatus:type_name -> service_layer.SLErrorStatus
	30, // 15: service_layer.SLMplsPath.NexthopAddress:type_name -> service_layer.SLIpAddress
	31, // 16: service_layer.SLMplsPath.NexthopInterface:type_name -> service_layer.SLInterface
	0,  // 17: service_layer.SLMplsPath.Action:type_name -> service_layer.SlLabelAction
	30, // 18: service_layer.SLMplsPath.RemoteAddress:type_name -> service_layer.SLIpAddress
	17, // 19: service_layer.SLMplsPath.SlMplsCosVal:type_name -> service_layer.SLMplsCos
	17, // 20: service_layer.SLMplsIlmKey.SlMplsCosVal:type_name -> service_layer.SLMplsCos
	26, // 21: service_layer.SLMplsIlmKey.Prefix:type_name -> service_layer.SLMplsIlmKey.IPPrefixKey
	16, // 22: service_layer.SLMplsIlmEntry.Key:type_name -> service_layer.SLMplsIlmKey
	15, // 23: service_layer.SLMplsIlmEntry.Paths:type_name -> service_layer.SLMplsPath
	2,  // 24: service_layer.SLMplsIlmEntry.Priority:type_name -> service_layer.SLMplsIlmEntry.UpdatePriority
	27, // 25: service_layer.SLMplsIlmMsg.Oper:type_name -> service_layer.SLObjectOp
	18, // 26: service_layer.SLMplsIlmMsg.MplsIlms:type_name -> service_layer.SLMplsIlmEntry
	28, // 27: service_layer.SLMplsIlmRes.ErrStatus:type_name -> service_layer.SLErrorStatus
	16, // 28: service_layer.SLMplsIlmRes.Key:type_name -> service_layer.SLMplsIlmKey
	28, // 29: service_layer.SLMplsIlmMsgRsp.StatusSummary:type_name -> service_layer.SLErrorStatus
	20, // 30: service_layer.SLMplsIlmMsgRsp.Results:type_name -> service_layer.SLMplsIlmRes
	16, // 31: service_layer.SLMplsIlmGetMsg.Key:type_name -> service_layer.SLMplsIlmKey
	28, // 32: service_layer.SLMplsIlmGetMsgRsp.ErrStatus:type_name -> service_layer.SLErrorStatus
	18, // 33: service_layer.SLMplsIlmGetMsgRsp.Entries:type_name -> service_layer.SLMplsIlmEntry
	24, // 34: service_layer.SLMplsIlmKey.IPPrefixKey.V4Prefix:type_name -> service_layer.SLMplsIlmKey.IPv4PrefixKey
	25, // 35: service_layer.SLMplsIlmKey.IPPrefixKey.V6Prefix:type_name -> service_layer.SLMplsIlmKey.IPv6PrefixKey
	10, // 36: service_layer.SLMplsOper.SLMplsRegOp:input_type -> service_layer.SLMplsRegMsg
	12, // 37: service_layer.SLMplsOper.SLMplsGet:input_type -> service_layer.SLMplsGetMsg
	12, // 38: service_layer.SLMplsOper.SLMplsGetStats:input_type -> service_layer.SLMplsGetMsg
	4,  // 39: service_layer.SLMplsOper.SLMplsLabelBlockOp:input_type -> service_layer.SLMplsLabelBlockMsg
	7,  // 40: service_layer.SLMplsOper.SLMplsLabelBlockGet:input_type -> service_layer.SLMplsLabelBlockGetMsg
	19, // 41: service_layer.SLMplsOper.SLMplsIlmOp:input_type -> service_layer.SLMplsIlmMsg
	22, // 42: service_layer.SLMplsOper.SLMplsIlmGet:input_type -> service_layer.SLMplsIlmGetMsg
	19, // 43: service_layer.SLMplsOper.SLMplsIlmOpStream:input_type -> service_layer.SLMplsIlmMsg
	22, // 44: service_layer.SLMplsOper.SLMplsIlmGetStream:input_type -> service_layer.SLMplsIlmGetMsg
	11, // 45: service_layer.SLMplsOper.SLMplsRegOp:output_type -> service_layer.SLMplsRegMsgRsp
	13, // 46: service_layer.SLMplsOper.SLMplsGet:output_type -> service_layer.SLMplsGetMsgRsp
	14, // 47: service_layer.SLMplsOper.SLMplsGetStats:output_type -> service_layer.SLMplsGetStatsMsgRsp
	6,  // 48: service_layer.SLMplsOper.SLMplsLabelBlockOp:output_type -> service_layer.SLMplsLabelBlockMsgRsp
	8,  // 49: service_layer.SLMplsOper.SLMplsLabelBlockGet:output_type -> service_layer.SLMplsLabelBlockGetMsgRsp
	21, // 50: service_layer.SLMplsOper.SLMplsIlmOp:output_type -> service_layer.SLMplsIlmMsgRsp
	23, // 51: service_layer.SLMplsOper.SLMplsIlmGet:output_type -> service_layer.SLMplsIlmGetMsgRsp
	21, // 52: service_layer.SLMplsOper.SLMplsIlmOpStream:output_type -> service_layer.SLMplsIlmMsgRsp
	23, // 53: service_layer.SLMplsOper.SLMplsIlmGetStream:output_type -> service_layer.SLMplsIlmGetMsgRsp
...
func file_sl_mpls_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sl_mpls_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SLMplsIlmKey_IPv4PrefixKey); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sl_mpls_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SLMplsIlmKey_IPv6PrefixKey); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sl_mpls_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SLMplsIlmKey_IPPrefixKey); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_sl_mpls_proto_msgTypes[23].OneofWrappers = []interface{}{
		(*SLMplsIlmKey_IPPrefixKey_V4Prefix)(nil),
		(*SLMplsIlmKey_IPPrefixKey_V6Prefix)(nil),
	}
	type x struct{}
