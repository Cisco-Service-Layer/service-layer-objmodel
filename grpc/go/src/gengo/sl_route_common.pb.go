...
var file_sl_route_common_proto_rawDesc = []byte{
	...
	0x74, 0x4f, 0x70, 0x52, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xa5, 0x01, 0x0a, 0x0d,
	...
	0x54, 0x61, 0x67, 0x22, 0x85, 0x04, 0x0a, 0x0b, 0x53, 0x4c, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x50,
	...
	0x72, 0x4d, 0x61, 0x63, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x2a, 0xca, 0x01, 0x0a, 0x0b,
	...
	0x50, 0x45, 0x5f, 0x56, 0x52, 0x46, 0x10, 0x06, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_sl_route_common_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_sl_route_common_proto_goTypes = []interface{}{
	...
	(SLRegOp)(0),                        // 20: service_layer.SLRegOp
	(SLNotifOp)(0),                      // 21: service_layer.SLNotifOp
	(SLObjectOp)(0),                     // 22: service_layer.SLObjectOp
	(*SLIpAddress)(nil),                 // 23: service_layer.SLIpAddress
	(*SLInterface)(nil),                 // 24: service_layer.SLInterface
	(SLEncapType)(0),                    // 25: service_layer.SLEncapType
}
var file_sl_route_common_proto_depIdxs = []int32{
	19, // 0: service_layer.SLRouteGlobalsGetMsgRsp.ErrStatus:type_name -> service_layer.SLErrorStatus
	19, // 1: service_layer.SLRouteGlobalStatsGetMsgRsp.ErrStatus:type_name -> service_layer.SLErrorStatus
	20, // 2: service_layer.SLVrfRegMsg.Oper:type_name -> service_layer.SLRegOp
	5,  // 3: service_layer.SLVrfRegMsg.VrfRegMsgs:type_name -> service_layer.SLVrfReg
	19, // 4: service_layer.SLVrfRegMsgRes.ErrStatus:type_name -> service_layer.SLErrorStatus
	19, // 5: service_layer.SLVrfRegMsgRsp.StatusSummary:type_name -> service_layer.SLErrorStatus
	7,  // 6: service_layer.SLVrfRegMsgRsp.Results:type_name -> service_layer.SLVrfRegMsgRes
	19, // 7: service_layer.SLVrfRegGetMsgRsp.ErrStatus:type_name -> service_layer.SLErrorStatus
	5,  // 8: service_layer.SLVrfRegGetMsgRsp.Entries:type_name -> service_layer.SLVrfReg
	19, // 9: service_layer.SLVRFGetStatsMsgRsp.ErrStatus:type_name -> service_layer.SLErrorStatus
	11, // 10: service_layer.SLVRFGetStatsMsgRsp.Entries:type_name -> service_layer.SLVRFGetStatsMsgRes
	21, // 11: service_layer.SLRouteGetNotifMsg.Oper:type_name -> service_layer.SLNotifOp
	19, // 12: service_layer.SLRouteNotifStatus.NotifStatus:type_name -> service_layer.SLErrorStatus
	22, // 13: service_layer.SLVrfNotif.Status:type_name -> service_layer.SLObjectOp
	23, // 14: service_layer.SLRoutePath.NexthopAddress:type_name -> service_layer.SLIpAddress
	24, // 15: service_layer.SLRoutePath.NexthopInterface:type_name -> service_layer.SLInterface
	23, // 16: service_layer.SLRoutePath.RemoteAddress:type_name -> service_layer.SLIpAddress
	25, // 17: service_layer.SLRoutePath.EncapType:type_name -> service_layer.SLEncapType
