...
type SLVxLANPath struct {
	...
	// Virtual network identifier flags.
	VNIFlags uint32 `protobuf:"varint,2,opt,name=VNIFlags,proto3" json:"VNIFlags,omitempty"`
	// Source MAC address is mandatory.
	SourceMacAddress []byte `protobuf:"bytes,3,opt,name=SourceMacAddress,proto3" json:"SourceMacAddress,omitempty"`
	// Destination MAC address is optional. If not set,
	// Zero MAC address is used as the destination MAC address.
	DestMacAddress []byte `protobuf:"bytes,4,opt,name=DestMacAddress,proto3" json:"DestMacAddress,omitempty"`
	// Source IP address is mandatory.
	SrcIpAddress *SLIpAddress `protobuf:"bytes,5,opt,name=SrcIpAddress,proto3" json:"SrcIpAddress,omitempty"`
	// Destination IP address is mandatory.
	DestIpAddress *SLIpAddress `protobuf:"bytes,6,opt,name=DestIpAddress,proto3" json:"DestIpAddress,omitempty"`
}
...
func (x *SLVxLANPath) GetVNIFlags() uint32 {
	if x != nil {
		return x.VNIFlags
	}
	return 0
...
type SLRoutePath struct {
	...
	// For ENCAP_VXLAN, this field is optional and:
	//   - if set, packet is forwarded to NextHopAddress.
	//   - if not set, tunnel's destination IP address is resolved
	//     to determine packet's next hop.
	...
	// Create local tunnel endpoint. Apply VxLAN encapsulation
	// on the IP packet.
...
var file_sl_route_common_proto_rawDesc = []byte{
	...
	0x28, 0x0d, 0x52, 0x05, 0x46, 0x6c, 0x61, 0x67, 0x73, 0x22, 0x91, 0x02, 0x0a, 0x0b, 0x53, 0x4c,
	0x56, 0x78, 0x4c, 0x41, 0x4e, 0x50, 0x61, 0x74, 0x68, 0x12, 0x10, 0x0a, 0x03, 0x56, 0x4e, 0x49,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x56, 0x4e, 0x49, 0x12, 0x1a, 0x0a, 0x08, 0x56,
	0x4e, 0x49, 0x46, 0x6c, 0x61, 0x67, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x56,
	0x4e, 0x49, 0x46, 0x6c, 0x61, 0x67, 0x73, 0x12, 0x2a, 0x0a, 0x10, 0x53, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x4d, 0x61, 0x63, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0e, 0x44, 0x65, 0x73,
	0x74, 0x4d, 0x61, 0x63, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x3e, 0x0a, 0x0c, 0x53,
	0x72, 0x63, 0x49, 0x70, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	0x65, 0x73, 0x74, 0x49, 0x70, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x06, 0x20, 0x01,
	...
	0x44, 0x65, 0x73, 0x74, 0x49, 0x70, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xbf, 0x04,
	...
	,
	...
	,
