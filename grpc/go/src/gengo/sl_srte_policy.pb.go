...
const (
	...
	SLSrBindingSIDAllocationMode_SL_SR_BSID_EXPLICIT SLSrBindingSIDAllocationMode = 0
	// Dynamically allocated BSID
	SLSrBindingSIDAllocationMode_SL_SR_BSID_DYNAMIC SLSrBindingSIDAllocationMode = 1
)

// Enum value maps for SLSrBindingSIDAllocationMode.
var (
	SLSrBindingSIDAllocationMode_name = map[int32]string{
		0: "SL_SR_BSID_EXPLICIT",
		1: "SL_SR_BSID_DYNAMIC",
	}
...
const (
	...
	SLSrConstraints_SegmentConstraints_SL_SR_PROTECTED_PREFERRED SLSrConstraints_SegmentConstraints_ProtectionType = 0
	// Segment list is made only of protected (i.e., FRR-protected) segments
	SLSrConstraints_SegmentConstraints_SL_SR_PROTECTED_ONLY SLSrConstraints_SegmentConstraints_ProtectionType = 1
	// Unprotected segments are preferred over protected ones.
	SLSrConstraints_SegmentConstraints_SL_SR_UNPROTECTED_PREFERRED SLSrConstraints_SegmentConstraints_ProtectionType = 2
	// Segment list is made only of unprotected (i.e., non FRR-protected) segments
	SLSrConstraints_SegmentConstraints_SL_SR_UNPROTECTED_ONLY SLSrConstraints_SegmentConstraints_ProtectionType = 3
)
...
type SLSrDynamicCP struct {
	...
	MetricMargin *SLSrMetricMargin `protobuf:"bytes,3,opt,name=metric_margin,json=metricMargin,proto3" json:"metric_margin,omitempty"`
...
type SLSrBindingSID struct {
	...
	AllocationMode SLSrBindingSIDAllocationMode `protobuf:"varint,1,opt,name=allocation_mode,json=allocationMode,proto3,enum=service_layer.SLSrBindingSIDAllocationMode" json:"allocation_mode,omitempty"`
	// Expected to be filled when mode is explicit and dataplane is MPLS
	MplsBsid uint32 `protobuf:"varint,2,opt,name=mpls_bsid,json=mplsBsid,proto3" json:"mpls_bsid,omitempty"`
	// SRv6 binding SID, expected when dataplane is SRv6
	Srv6Bsid *SLSrv6BindingSID `protobuf:"bytes,3,opt,name=srv6_bsid,json=srv6Bsid,proto3" json:"srv6_bsid,omitempty"`
}
...
func (x *SLSrBindingSID) GetAllocationMode() SLSrBindingSIDAllocationMode {
	if x != nil {
		return x.AllocationMode
	}
	return SLSrBindingSIDAllocationMode_SL_SR_BSID_EXPLICIT
}

func (x *SLSrBindingSID) GetMplsBsid() uint32 {
	if x != nil {
		return x.MplsBsid
	}
	return 0
...
func (x *SLSrBindingSID) GetSrv6Bsid() *SLSrv6BindingSID {
	if x != nil {
		return x.Srv6Bsid
	}
	return nil
...
type SLSrPolicy struct {
	...
	// a non-zero value.
	ProfileId uint32 `protobuf:"varint,5,opt,name=profile_id,json=profileId,proto3" json:"profile_id,omitempty"`
}
...
type SLSrConstraints_SegmentConstraints struct {
	...
	SidAlgo    uint32                                            `protobuf:"varint,2,opt,name=sid_algo,json=sidAlgo,proto3" json:"sid_algo,omitempty"`
...
func (x *SLSrConstraints_SegmentConstraints) GetProtection() SLSrConstraints_SegmentConstraints_ProtectionType {
	...
	return SLSrConstraints_SegmentConstraints_SL_SR_PROTECTED_PREFERRED
}
...
var file_sl_srte_policy_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x65, 0x79, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	...
	,
	...
	0x63, 0x79, 0x4b, 0x65, 0x79, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x29, 0x0a, 0x10, 0x74, 0x72,
	0x61, 0x6e, 0x73, 0x69, 0x74, 0x5f, 0x65, 0x6c, 0x69, 0x67, 0x69, 0x62, 0x6c, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x69, 0x74, 0x45, 0x6c, 0x69,
	0x67, 0x69, 0x62, 0x6c, 0x65, 0x12, 0x32, 0x0a, 0x03, 0x43, 0x50, 0x73, 0x18, 0x03, 0x20, 0x03,
	...
	,
...
var file_sl_srte_policy_proto_depIdxs = []int32{
	13, // 0: service_layer.SLSrExplicitCP.segment_list:type_name -> service_layer.SLSrSegmentList
	...
	16, // 4: service_layer.SLSrDynamicCP.o_metric:type_name -> service_layer.SLSrMetricType
	3,  // 5: service_layer.SLSrDynamicCP.constraints:type_name -> service_layer.SLSrConstraints
	17, // 6: service_layer.SLSrDynamicCP.metric_margin:type_name -> service_layer.SLSrMetricMargin
	...
	0,  // 11: service_layer.SLSrBindingSID.allocation_mode:type_name -> service_layer.SLSrBindingSIDAllocationMode
	6,  // 12: service_layer.SLSrBindingSID.srv6_bsid:type_name -> service_layer.SLSrv6BindingSID
