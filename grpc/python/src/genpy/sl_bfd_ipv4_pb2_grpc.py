...
class SLBfdv4Oper(object):
    ...
    def SLBfdv4RegOp(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/service_layer.SLBfdv4Oper/SLBfdv4RegOp',
    ...
    def SLBfdv4GetStats(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/service_layer.SLBfdv4Oper/SLBfdv4GetStats',
            sl__bfd__common__pb2.SLBfdGetMsg.SerializeToString,
    ...
    @staticmethod
    def SLBfdv4GetNotifStream(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/service_layer.SLBfdv4Oper/SLBfdv4GetNotifStream',
            sl__bfd__common__pb2.SLBfdGetNotifMsg.SerializeToString,
            sl__bfd__ipv4__pb2.SLBfdv4Notif.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def SLBfdv4SessionOp(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/service_layer.SLBfdv4Oper/SLBfdv4SessionOp',
            sl__bfd__ipv4__pb2.SLBfdv4Msg.SerializeToString,
            sl__bfd__ipv4__pb2.SLBfdv4MsgRsp.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def SLBfdv4SessionGet(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/service_layer.SLBfdv4Oper/SLBfdv4SessionGet',
            sl__bfd__ipv4__pb2.SLBfdv4GetMsg.SerializeToString,
            sl__bfd__ipv4__pb2.SLBfdv4GetMsgRsp.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
