...
#define SL_GENERATED_ERR_STRINGS \
    ...
    {SL_FIB_INUSE_SUCCESS ,\
        " The forwarding chain using this object is fully active in hardware.  "\
        },\
    {SL_ACK_PERMIT_NOT_SUPPORTED ,\
        " Ack permit is not supported when ack type is not RIB_AND_FIB_ACK or RIB_FIB_INUSE_ACK.  "\
        },\
    {SL_INVALID_ACKTYPE ,\
        " Given ack type is not permitted on object of this type.  "\
        },\
